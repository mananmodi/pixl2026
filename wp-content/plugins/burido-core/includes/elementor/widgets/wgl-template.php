...
class WGL_Template extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Template', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'template_border_color_idle-dynamic',
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'template_border_border!' => ['', 'none'],
                    'template_border_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-template' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'template_border_color_hover-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .template:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
