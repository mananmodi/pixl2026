...
class WGL_Clients extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Clients', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    7 => esc_html__('7 (seven)', 'burido-core'),
                    8 => esc_html__('8 (eight)', 'burido-core'),
                    9 => esc_html__('9 (nine)', 'burido-core'),
                    10 => esc_html__('10 (ten)', 'burido-core'),
                ],
                'default' => 6,
                'selectors' => [
        ...
        $this->add_control(
            'items_carousel',
            [
                'label' => esc_html__('Carousel Columns Amount', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'condition' => [ 'use_carousel!' => '' ],
                'options' => [
                    1 => esc_html__('1 (one)', 'burido-core'),
        ...
        $repeater->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'description' => esc_html__('For \'Toggle Image\' animations only.', 'burido-core' ),
                'default' => ['url' => ''],
            ]
        );
	    ...
	    $repeater->add_responsive_control(
		    'thumbnail_width',
		    [
			    'label' => esc_html__('Image/Images Width', 'burido-core'),
        ...
        $repeater->add_responsive_control(
            'item_visibility',
            [
                'label' => esc_html__('Item Visibility', 'burido-core'),
                'description' => esc_html__('You can hide some items on responsive', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__('Default', 'burido-core'),
                    'display: block' => esc_html__('Show', 'burido-core'),
                    'display: none' => esc_html__('Hide', 'burido-core'),
                ],
                'default' => '',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'items_wrapper_width',
            [
                'label' => esc_html__('Items Wrapper Width', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
                'label_block' => true,
                'dynamic' => ['active' => true],
                'range' => [
        ...
        $this->add_control(
            'item_link',
            [
                'label' => esc_html__('Set Link on', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => [
                    'image' => esc_html__('Image', 'burido-core'),
                    'wrapper' => esc_html__('Wrapper', 'burido-core'),
                ],
                'default' => 'image',
        ...
        $this->add_control(
            'item_anim',
            [
                'label' => esc_html__('Thumbnail Animation', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'label_block' => true,
                'options' => [
                    'none' => esc_html__('None', 'burido-core'),
                    'ex_images' => esc_html__('Toggle Image - Fade', 'burido-core'),
                    'ex_images_ver' => esc_html__('Toggle Image - Vertical', 'burido-core'),
                    'grayscale' => esc_html__('Grayscale', 'burido-core'),
                    'opacity' => esc_html__('Opacity', 'burido-core'),
                    'zoom' => esc_html__('Zoom', 'burido-core'),
                    'contrast' => esc_html__('Contrast', 'burido-core'),
                    'blur-1' => esc_html__('Blur 1', 'burido-core'),
                    'blur-2' => esc_html__('Blur 2', 'burido-core'),
                    'invert' => esc_html__('Invert', 'burido-core'),
                    'mask_image' => esc_html__('Mask Image', 'burido-core'),
                ],
                'default' => 'ex_images',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .clients_image' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .clients_image:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Images', 'burido-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'item_anim' => 'mask_image',
                    'image_mask_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .image_wrapper.mask_image' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .image_wrapper.mask_image:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
