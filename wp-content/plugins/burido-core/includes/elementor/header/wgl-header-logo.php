...
class WGL_Header_Logo extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Logo', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'use_custom_logo',
            [
                'label' => esc_html__('Use Custom Logo?', 'burido-core'),
        ...
        $this->add_control(
            'custom_logo',
            [
                'label' => esc_html__('Custom Logo', 'burido-core'),
        ...
        $this->add_control(
            'flex_grow',
            [
                'label' => esc_html__('Flex Grow', 'burido-core'),
        ...
        $this->add_control(
            'enable_logo_height',
            [
                'label' => esc_html__('Enable Logo Height?', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'condition' => ['use_custom_logo!' => ''],
            ]
        );
        ...
        $this->add_control(
            'logo_height',
            [
                'label' => esc_html__('Logo Height', 'burido-core'),
                'type' => Controls_Manager::NUMBER,
			    'dynamic' => ['active' => true],
                'condition' => [
                    'use_custom_logo!' => '',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Mobile Entrance Animation', 'burido-core' ),
    ...
    public function render()
    {
        ...
        new \Burido_Get_Logo('bottom', false, $logo, $custom_size);
    }
}
