...
class WGL_Working_Hours extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Working Hours', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'default' => esc_html__('Monday', 'burido-core'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
			    'dynamic' => ['active' => true],
                'default' => esc_html__('8.00 - 21.00', 'burido-core'),
            ]
        );
        ...
        $repeater->add_control(
            'custom_colors',
            [
                'label' => esc_html__('Custom Colors', 'burido-core'),
        ...
        $repeater->add_control(
            'hours_color',
            [
                'label' => esc_html__('Hours Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
        ...
        $this->add_control(
            'items',
            [
                'label' => esc_html__('Days', 'burido-core'),
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    ['working_day' => esc_html__('Monday', 'burido-core')],
                    ['working_day' => esc_html__('Tuesday', 'burido-core')],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Item Styles', 'burido-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Day Styles', 'burido-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => ['day_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .working-item_day' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Hours Styles', 'burido-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['hours_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .working-item_hours' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'line_color',
            [
                'label' => esc_html__('Line Between Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'line_color-dynamic',
            [
                'label' => esc_html__('Line Between Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['line_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .working-item::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
