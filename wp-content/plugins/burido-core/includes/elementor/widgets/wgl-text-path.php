...
class WGL_Text_Path extends Widget_Base {
    ...
    {
        return esc_html__('WGL Text Path', 'burido-core');
    }
	...
	protected function register_content_tab() {
		$wgl_shape = [];
		$wgl_shape['wgl_wave'] = esc_html__( 'WGL Wave', 'burido-core' );
		$wgl_shape['wgl_line_simple'] = esc_html__( 'WGL Line', 'burido-core' );

		$this->start_controls_section(
			'section_content_text_path',
			[
				'label' => esc_html__( 'Text Path', 'burido-core' ),
		...
		$this->add_control(
			...
			[
				...
				'rows' => 3,
				'label_block' => true,
				'default' => esc_html__( 'Curvy Text', 'burido-core' ),
		...
		$this->add_control(
			'path',
			[
				'label' => esc_html__( 'Path Type', 'burido-core' ),
		...
		$this->add_control(
			'custom_path',
			[
				'label' => esc_html__( 'SVG', 'burido-core' ),
				...
				'description' => sprintf( esc_html__( 'Want to create custom text paths with SVG?' , 'burido-core' ).' <a target="_blank" href="%s">Learn More</a>', 'https://go.elementor.com/text-path-create-paths' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
                    ...
                    'scroll' => esc_html__('Scroll', 'burido-core'),
                    'loop' => esc_html__('Loop', 'burido-core'),
                ],
				'default' => 'loop',
			]
		);
		...
		$this->add_control(
            'stop_hover',
            [
                'label' => esc_html__('Stop on Hover', 'burido-core'),
		...
		$this->add_control(
			'divider_text',
			[
				'label' => esc_html__( 'Add Divider', 'burido-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'burido-core' ),
				'label_off' => esc_html__( 'Off', 'burido-core' ),
				'default' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
                    'line' => esc_html__('Line', 'burido-core'),
                    'star' => esc_html__('Star', 'burido-core'),
					'arrow' => esc_html__('Arrow', 'burido-core'),
		...
		$this->add_control(
			'divider_custom',
			[
				'label' => esc_html__( 'Divider Custom', 'burido-core' ),
		...
		$this->add_control(
			'clone_text',
			[
				'label' => esc_html__( 'Clone Text', 'burido-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'burido-core' ),
				'label_off' => esc_html__( 'Off', 'burido-core' ),
				'default' => 'yes',
		...
		$this->add_control(
            'backspace_count',
            [
                'label' => esc_html__('Space After Cloned Element', 'burido-core'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				['active' => true],
				'placeholder' => esc_html__( 'Paste URL or type', 'burido-core' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'show_path',
			[
				'label' => esc_html__( 'Show Path', 'burido-core' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'burido-core' ),
				'label_off' => esc_html__( 'Off', 'burido-core' ),
				'separator' => 'before',
	...
	protected function register_style_tab() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-text-path' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}' => 'font-family: var(--burido-{{VALUE}}-font-family);',
                ],
            ]
        );
		...
		$this->add_responsive_control(
			'word_spacing',
			[
				'label' => esc_html__( 'Word Spacing', 'burido-core' ),
				'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
		...
		$this->add_control(
            'animation_speed',
            [
                'label' => esc_html__('Animation Duration', 'burido-core'),
                'type' => Controls_Manager::NUMBER,
			    'dynamic' => ['active' => true],
                'min' => 1,
                'default' => 30000,
		...
		$this->add_responsive_control(
			'start_point',
			[
				'label' => esc_html__( 'Starting Point', 'burido-core' ),
				'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
				'size_units' => [ '%', 'custom' ],
				'range' => [
		...
		$this->add_responsive_control(
			'end_point',
			[
				'label' => esc_html__( 'Ending Point', 'burido-core' ),
				'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
				'size_units' => [ '%', 'custom' ],
				'range' => [
		...
		$this->add_control(
			'text_color_normal',
			[
				'label' => esc_html__( 'Text Color / Fill Color', 'burido-core' ),
				'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
			    'default' => '#EFEFEF',
				'selectors' => [
        ...
        $this->add_control(
            'text_color_normal-dynamic',
            [
                'label' => esc_html__('Text Color / Fill Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['text_color_normal!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} svg text' => 'fill: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .text--word' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'stroke_text_color_normal-dynamic',
            [
                'label' => esc_html__('Stroke Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['stroke_text_color_normal!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} svg textPath,
                     body.wgl_dynamic_colors-active {{WRAPPER}} svg text' => 'stroke: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .text--word' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		...
		$this->add_control(
			'text_color_hover',
			[
				'label' => esc_html__( 'Fill Color', 'burido-core' ),
				'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
				'default' => '',
				'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Fill Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['text_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} svg text:hover' => 'fill: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .text--word:hover .text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'stroke_text_color_hover-dynamic',
            [
                'label' => esc_html__('Stroke Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['stroke_text_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} svg text:hover textPath,
                     body.wgl_dynamic_colors-active {{WRAPPER}} svg text:hover' => 'stroke: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .text--word:hover .text' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            'divider_fill_normal-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['divider_fill_normal!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} tspan.divider,
					 body.wgl_dynamic_colors-active {{WRAPPER}} .divider svg' => 'fill: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .text--word .divider' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'stroke_divider_color_normal-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['stroke_divider_color_normal!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} tspan.divider,
					 body.wgl_dynamic_colors-active {{WRAPPER}} .divider svg' => 'stroke: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .text--word .divider' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            'divider_fill_hover-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['divider_fill_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover tspan.divider,
					 body.wgl_dynamic_colors-active {{WRAPPER}}:hover .divider svg' => 'fill: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .text--word .divider' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            'stroke_divider_color_hover-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['stroke_divider_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .divider svg' => 'stroke-color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .text--word .divider' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
		...
		$this->start_controls_section(
			'section_style_path',
			[
				'label' => esc_html__( 'Path', 'burido-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_path!' => '',
				],
        ...
        $this->add_control(
            'path_fill_normal-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['path_fill_normal!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}' => '--path-fill: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            'stroke_color_normal-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['stroke_color_normal!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}' => '--stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            'path_fill_hover-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['path_fill_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}' => '--path-fill-hover: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            'stroke_color_hover-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['stroke_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}' => '--stroke-color-hover: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-icon' => 'fill: {{VALUE}}; color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'icon_bg_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['icon_bg_idle!' => ''],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-text-path:hover .wgl-icon' => 'fill: {{VALUE}}; color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'icon_bg_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['icon_bg_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-text-path:hover .wgl-icon,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-text-path:hover .wgl-image-box_img' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
	...
	protected function render() {
		...
		elseif ( 'custom' !== $_s['path'] ) {
			$data_url = method_exists('Elementor\Modules\Shapes\Module', 'get_path_url') ? Shapes_Module::get_path_url( $_s['path'] ) : '';
			
			// Remove the HTTP protocol to prevent Mixed Content error.
			$data_url = preg_replace( '/^https?:/i', '', $data_url );
			...
			$data_url = wp_get_attachment_url( $_s['custom_path']['id'] );
