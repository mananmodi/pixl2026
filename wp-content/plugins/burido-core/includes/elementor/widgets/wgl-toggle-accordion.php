...
class WGL_Toggle_Accordion extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Toggle/Accordion', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'accordion' => esc_html__('Accordion', 'burido-core'),
                    'toggle' => esc_html__('Toggle', 'burido-core'),
                ],
                'default' => 'toggle',
            ]
        );
        ...
        $this->add_control(
            'acc_trigger',
            [
                'label' => esc_html__('Trigger', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'condition' => ['acc_type' => 'toggle'],
                'options' => [
                    'click' => esc_html__('Click', 'burido-core'),
                    'hover' => esc_html__('Hover', 'burido-core'),
                ],
                'default' => 'click',
            ]
        );
        ...
        $this->add_control(
            'heading_desktop',
            [
                'label' => esc_html__('Icon Settings', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'plus' => esc_html__('Plus/Minus', 'burido-core'),
                    'plus_bold' => esc_html__('Plus/Minus Bold', 'burido-core'),
        ...
        $this->add_control(
            'acc_icon',
            [
                'label' => esc_html__('Choose Icon', 'burido-core'),
        ...
        $this->add_control(
            'icon_alignment',
            [
                'label' => esc_html__('Icon Position', 'burido-core'),
        ...
        $this->add_control(
            'icon_v_alignment',
            [
                'label' => esc_html__('Icon Vertical Alignment', 'burido-core'),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
                'condition' => ['enable_acc_icon!' => 'none'],
                'options' => [
        ...
        $repeater->add_control(
			'acc_tab_title',
			[
                'label' => esc_html__('Accordion Title', 'burido-core'),
                'type' => Controls_Manager::TEXTAREA,
			    'dynamic' => ['active' => true],
                'default' => esc_html__('Accordion Title', 'burido-core'),
			]
        );
        $repeater->add_control(
            'acc_link',
        ...
        $repeater->add_control(
			'acc_content',
			[
                'label' => esc_html__('Accordion Content', 'burido-core'),
        ...
        'acc_tab_panel_bg_item_xpos_active',
            [
                'label' => esc_html__( 'X Position on Active', 'burido-core' ),
        ...
        $repeater->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Y Position on Active', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'responsive' => true,
                'size_units' => [ 'px', '%', 'em', 'rem', 'vw', 'custom' ],
                'range' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'seperator' => 'before',
                'default' => [
                    ['acc_tab_title' => esc_html__('Accordion Title 1', 'burido-core'), 'acc_tab_def_active' => 'yes'],
	                ['acc_tab_title' => esc_html__('Accordion Title 2', 'burido-core')],
                    ['acc_tab_title' => esc_html__('Accordion Title 3', 'burido-core')],
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Delimiter', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'range' => [
                    'px' => ['min' => 0, 'max' => 10],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hide Delimiter on Top', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hide Delimiter om Bottom', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'condition' => ['acc_tab_panel_delimiter[size]!' => ['', 0]],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Delimiter Position', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%', 'custom'],
        ...
        $this->add_control(
            'acc_tab_panel_bg_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_tab_panel_bg_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Delimiter Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'dynamic' => ['active' => true],
                'condition' => ['acc_tab_panel_delimiter[size]!' => ['', 0]],
                'selectors' => [
        ...
        $this->add_control(
            'acc_tab_panel_delimiter_color_idle-dynamic',
            [
                'label' => esc_html__('Delimiter Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                    'acc_tab_panel_delimiter[size]!' => ['', 0],
                    'acc_tab_panel_delimiter_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel::before' => '--acc-delimiter-color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:last-child::before' => '--acc-delimiter-color-last: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Overlay Opacity', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'condition' => [
        ...
        $this->add_control(
            'acc_tab_panel_bg_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_tab_panel_bg_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'acc_tab_panel_delimiter_color_hover-dynamic',
            [
                'label' => esc_html__('Delimiter Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover::before,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover + .wgl-accordion_panel::before' => '--acc-delimiter-color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:last-child:hover::before' => '--acc-delimiter-color-last: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'acc_tab_panel_bg_active-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'condition' => ['acc_tab_panel_bg_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'acc_tab_panel_delimiter_color_active-dynamic',
            [
                'label' => esc_html__('Delimiter Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_tab_panel_delimiter_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active::before,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active + .wgl-accordion_panel::before' => '--acc-delimiter-color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active:last-child::before' => '--acc-delimiter-color-last: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'acc_title_color-dynamic',
            [
                'label' => esc_html__('Title Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
			    'dynamic' => ['active' => true],
                'condition' => ['acc_title_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_header' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'acc_title_bg_color_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
			    'dynamic' => ['active' => true],
                'condition' => ['acc_title_bg_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_header' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'acc_title_color_hover-dynamic',
            [
                'label' => esc_html__('Title Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_title_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_header:hover .wgl-accordion_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'acc_title_bg_color_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_title_bg_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_header:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'acc_title_color_active-dynamic',
            [
                'label' => esc_html__('Title Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_title_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active .wgl-accordion_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'acc_title_bg_color_active-dynamic',
            [
                'label' => esc_html__('Title Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_title_bg_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active .wgl-accordion_header' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_control(
            'title_pref_position',
            [
                'label' => esc_html__('Prefix Position', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Prefix Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'acc_title_pref_color_idle-dynamic',
            [
                'label' => esc_html__('Prefix Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_title_pref_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel .wgl-accordion_title-prefix' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            'title_pref_color_hover-dynamic',
            [
                'label' => esc_html__('Prefix Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['title_pref_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover .wgl-accordion_title-prefix' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            'acc_title_pref_color_active-dynamic',
            [
                'label' => esc_html__('Prefix Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_title_pref_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active .wgl-accordion_title-prefix' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
			    'default' => WGL_Globals::get_h_font_color(0.25),
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['icon_border_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_icon' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'icon_flip_y_idle',
            [
                'label' => esc_html__( 'Flip Vertical', 'burido-core' ),
                'type' => Controls_Manager::CHOOSE,
                'toggle' => false,
                'options' => [
                    '1' => [
                    ...
                    '-1' => [
                        'title' => esc_html__( 'Flip Horizontal', 'burido-core' ),
                        'icon' => 'eicon-flip',
                    ],
                ],
                'condition' => ['enable_acc_icon' => 'custom'],
        ...
        $this->add_control(
            'acc_icon_color_hover-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_icon_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover .wgl-accordion_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover .wgl-accordion_icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['icon_border_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel:hover .wgl-accordion_icon' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active .wgl-accordion_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active .wgl-accordion_icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_panel.active .wgl-accordion_icon' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'acc_content_color-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_content_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_content' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'acc_content_bg_color-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['acc_content_bg_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-accordion_content' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
