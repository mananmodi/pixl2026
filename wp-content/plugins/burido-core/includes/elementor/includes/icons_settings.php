        ...
        public static function init($self, $attrs = [])
        {
            ...
            if ($section) {
                $self->start_controls_section(
                    ...
                    [
                        'label' => sprintf(esc_html__('%s Icon/Image', 'burido-core'), $section_label_suffix),
            ...
            $self->add_control(
                ...
                [
                    'label' => esc_html__('Icon Class', 'burido-core'),
            ...
            $self->add_control(
                ...
                [
                    'label' => esc_html__('Image Class', 'burido-core'),
                    'type' => Controls_Manager::HIDDEN,
                    'condition' => [$prefix . 'icon_type' => 'image'] + ($attrs['condition'] ?? []),
        ...
        public function build($self, $atts, $pref)
        {
            ...
            if (
                ...
                if ('svg' === $icon_fontawesome['library']) {
                    $render .= '<span class="icon elementor-icon">';
                }
                ...
                if ($is_new || $migrated) {
                    ...
                    $render .= '<i class="icon elementor-icon ' . esc_attr($icon_fontawesome['value']) . '"></i>';
                }
