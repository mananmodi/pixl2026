...
class WGL_Header_List_Info extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Icon + Text', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => esc_attr__('List Item', 'burido-core'),
                'default' => esc_html__('List Item', 'burido-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    ['text' => esc_html__('List Item #1', 'burido-core')],
                    ['text' => esc_html__('List Item #2', 'burido-core')],
                    ['text' => esc_html__('List Item #3', 'burido-core')],
                ],
                'title_field' => '{{{ text }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'section_style_list',
            [
                'label' => esc_html__('List', 'burido-core'),
        ...
        $this->add_responsive_control(
            'space_between',
            [
                'label' => esc_html__('Gap Items', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'solid' => esc_html__('Solid', 'burido-core'),
                    'double' => esc_html__('Double', 'burido-core'),
                    'dotted' => esc_html__('Dotted', 'burido-core'),
                    'dashed' => esc_html__('Dashed', 'burido-core'),
                ],
                'default' => 'solid',
                'selectors' => [
        ...
        $this->add_control(
            'divider_weight',
            [
                'label' => esc_html__('Weight', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'condition' => ['divider' => 'yes'],
                'range' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-item:not(:last-child)::after' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-icon i' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-item:hover .elementor-icon-list-icon i' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-item:hover .elementor-icon-list-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_spacing',
            [
                'label' => esc_html__('Gap Icons', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => ['min' => 0, 'max' => 100],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon-list-item:hover .elementor-icon-list-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'text_indent',
            [
                'label' => esc_html__('Text Indent', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'separator' => 'before',
                'range' => [
