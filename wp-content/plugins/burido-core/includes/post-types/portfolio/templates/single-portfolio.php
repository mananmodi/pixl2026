...
echo '<div class="row', apply_filters('wgl/row/class', $row_class), '">';
    echo '<div id="main-content" class="wgl_col-', apply_filters('wgl/column/class', $column), '">';
        ...
        if (
            $related_enabled
            && class_exists('WGL_Extensions_Core') // TODO: maybe `Burido_Core` ?
            ...
            $cursor_tooltip = WGL_Framework::get_option('pf_tooltip_r') ? 'pf_cursor_tooltip' : 'under_image';
            ...
            $related_atts = [
                ...
                'tooltip_text' => esc_html__('MORE', 'burido-core'),
                'tooltip_descr' => '',
            ...
            if ($query->post_count) {
                echo '<section class="related_portfolio">';
                    ...
                    if (!empty($related_section_title)) {
                        echo '<div class="burido_module_title">',
                            '<h4>',
