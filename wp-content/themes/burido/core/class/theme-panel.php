...
if (!class_exists('WGL_Theme_Panel')) {
    ...
    class WGL_Theme_Panel
    {
        ...
        {
            add_menu_page (
                esc_html__('WebGeniusLab', 'burido'),
                esc_html__('WebGeniusLab', 'burido'),
            ...
            $submenu = [];
            $submenu[] = [
                esc_html__('Welcome', 'burido'), // page_title
                esc_html__('Welcome', 'burido'), // menu_title
                'manage_options', // capability
            ...
            $submenu[] = [
                esc_html__('Requirements', 'burido'), // page_title
                esc_html__('Requirements', 'burido'), // menu_title
            ...
            $submenu[] = [
                esc_html__('Activate Theme', 'burido'), // page_title
                esc_html__('Activate Theme', 'burido'), // menu_title
                'edit_posts', // capability
            ...
            if(WGL_Framework::wgl_theme_activated()){
                if (current_user_can( 'activate_plugins' )):
                    $submenu[] = [
                        esc_html__('Theme Plugins', 'burido'), // page_title
                        esc_html__('Theme Plugins', 'burido'), // menu_title
                        'edit_posts', // capability
            ...
            if ( !class_exists( 'WGL_Extensions_Core' ) ||  !class_exists('Burido_Core') || !WGL_Framework::wgl_theme_activated() ) {
                $submenu[] = [
                    esc_html__('Demo Import', 'burido'), // page_title
                    esc_html__('Demo Import', 'burido'), // menu_title
                    'edit_posts', // capability
                    'wgl-check-activation', // menu_slug
                    [ $this, 'redirect_activation' ] // function that will render its output
                ];
            ...
            if ( !class_exists( 'WGL_Extensions_Core' ) ||  !class_exists('Burido_Core') || !WGL_Framework::wgl_theme_activated() ) {
                $submenu[] = [
                    esc_html__('Theme Options', 'burido'),
                    esc_html__('Theme Options', 'burido'), 
                    'edit_posts',
                ...
                $submenu[] = [
                    esc_html__('Theme Options', 'burido'), // page_title
                    esc_html__('Theme Options', 'burido'), // menu_title
                    'edit_posts', // capability
            ...
            $submenu[] = [
                esc_html__('Help Center', 'burido'), // page_title
                esc_html__('Help Center', 'burido'), // menu_title
                'edit_posts', // capability
                ...
                <?php 
                    ...
                    <div class="btn-wrapper">
                        <button class="wgl-button wgl-wizard-all-plugins">
                            <?php esc_html_e( 'install & activate all plugins', 'burido' ); ?>
                        </button>
                        <?php
        ...
        public function get_prev_button( $page ) {
            ...
            <a class="wgl-nav-btn wgl-button-prev" href="<?php echo esc_url( $this->get_page_url( $page ) ); ?>">
                <?php esc_html_e( 'Previous step', 'burido' ); ?>
            </a>
            <?php
        }
        ...
        public function get_next_button( $page) {
            ...
            <a class="wgl-nav-btn wgl-button-next" href="<?php echo esc_url( $url ); ?>">
                <?php esc_html_e( 'Next step', 'burido' ); ?>
            </a>
            <?php
        }
