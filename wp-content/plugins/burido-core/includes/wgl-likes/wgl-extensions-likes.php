...
class WGL_Post_Likes
{
    ...
    public function get_likes_button($post_id = 0, $is_comment = false)
    {
        ...
        $title_like = esc_html_x('Like', 'likes button', 'burido-core');
        $title_unlike = esc_html_x('Unlike', 'likes button', 'burido-core');
    ...
    public function get_like_count($like_count)
    {
        ...
        $out .= '<span class="sl-count-text"> ' . esc_html( _n('like', 'likes', $like_count, 'burido-core') ) . '</span>';
    ...
    public function init()
    {
        ...
        if ( !wp_verify_nonce( $nonce, 'simple-likes-nonce' ) ) {
            exit( esc_html__('Not permitted', 'burido-core') );
        }
