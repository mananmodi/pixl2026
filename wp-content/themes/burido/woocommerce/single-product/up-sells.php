...
if (class_exists('Burido_Core') && class_exists('WGL_Extensions_Core') && class_exists('\Elementor\Plugin')) {
...
if ( $upsells ) :
	?><section class="up-sells upsells products"><?php
        ...
        $heading = apply_filters( 'woocommerce_product_upsells_products_heading', __( 'You may also like&hellip;', 'burido' ) );
