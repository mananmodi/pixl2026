...
class WGL_Social_Icons extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Social Icons', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'options' => [
                    'default' => esc_html__('Official', 'burido-core'),
        ...
        $repeater->add_control(
            'r_icon_color_idle-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['r_icon_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon i' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'r_icon_bg_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['r_icon_bg_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-social-icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'r_icon_border_color_idle-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['r_icon_border_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon:hover' => 'opacity: 1;',
        ...
        $repeater->add_control(
            'r_icon_color_hover-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['r_icon_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon:hover' => 'opacity: 1;',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon:hover i' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon:hover svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'r_icon_bg_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['r_icon_bg_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'r_icon_border_color_hover-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['r_icon_border_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.elementor-icon:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'social_icon_list',
            [
                'label' => esc_html__('Social Icons', 'burido-core'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'social_icon_title' => esc_html__('X', 'burido-core'),
                        'social_icon_fontawesome' => [
                    ...
                    [
                        'social_icon_title' => esc_html__('Facebook', 'burido-core'),
                        'social_icon_fontawesome' => [
                    ...
                    [
                        'social_icon_title' => esc_html__('LinkedIn', 'burido-core'),
                        'social_icon_fontawesome' => [
                    ...
                    [
                        'social_icon_title' => esc_html__('Instagram', 'burido-core'),
                        'social_icon_fontawesome' => [
        ...
        $this->add_control(
            'shape',
            [
                'label' => esc_html__('Shape', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'rounded' => esc_html__('Rounded', 'burido-core'),
                    'square' => esc_html__('Square', 'burido-core'),
                    'circle' => esc_html__('Circle', 'burido-core'),
                ],
                'default' => 'rounded',
        ...
        $this->add_control(
            'hover_lifting',
            [
                'label' => esc_html__('Lift Up the Icon', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon i' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .elementor-icon:hover' => 'opacity: 1;',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon:hover' => 'opacity: 1;',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon:hover i' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon:hover svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .elementor-icon:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_padding',
            [
                'label' => esc_html__('Container Size', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'em' => ['min' => 0, 'max' => 5 ],
        ...
        $this->add_responsive_control(
            'icon_spacing',
            [
                'label' => esc_html__('Containers Gap', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => ['min' => 0, 'max' => 100],
