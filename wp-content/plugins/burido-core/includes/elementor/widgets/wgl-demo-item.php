...
class WGL_Demo_Item extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Demo Item', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            ['label' => esc_html__('Demo Item Settings', 'burido-core')]
        );
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => '<span>01</span>'.esc_html__('This is the heading', 'burido-core'),
        ...
        $this->add_control(
            'demo_title_icon',
            [
                'label' => esc_html__('Add Icon for Title', 'burido-core'),
        ...
        $this->add_control(
            'lift_on_hover',
            [
                'label' => esc_html__('Lift Up on Hover', 'burido-core'),
        ...
        $this->add_control(
            'demo_link',
            [
                'label' => esc_html__('Demo Link', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .demo-item' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-demo-item:hover .demo-item' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'image_order',
            [
                'label' => esc_html__('Image Order (Position)', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .demo-item_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'title_decoration_color_idle-dynamic',
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'custom_fonts_title_text_decoration' => ['line-through', 'overline', 'underline'],
                    'title_decoration_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .demo-item_title' => 'text-decoration-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-demo-item:hover .demo-item_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'title_decoration_color_hover-dynamic',
            [
                'label' => esc_html__('Decoration Line Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-demo-item:hover .demo-item_title' => 'text-decoration-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-demo-item:hover .wgl-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'demo_subtitle_color_idle-dynamic',
            [
                'label' => esc_html__('BG Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['demo_subtitle_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .subtitle' => 'color: {{VALUE}}',
                ],
            ]
        );
	    $this->end_controls_tab();
        ...
        $this->add_control(
            'demo_subtitle_color_hover-dynamic',
            [
                'label' => esc_html__('BG Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['demo_subtitle_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-demo-item:hover .subtitle' => 'color: {{VALUE}}',
                ],
            ]
        );
	    $this->end_controls_tab();
