...
class WGL_Link_Overlay extends Widget_Base
{
    ...
    {
        return esc_html__( 'WGL Link Overlay', 'burido-core' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'overlay_layout',
            [
                'label' => esc_html__('Overlay', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '1st' => esc_html__('First Dom Element', 'burido-core'),
                    '2nd' => esc_html__('Second Dom Element', 'burido-core'),
                    '3rd' => esc_html__('Third Dom Element', 'burido-core'),
                    'column' => esc_html__('Column', 'burido-core'),
                    'row' => esc_html__('Row', 'burido-core'),
                ],
                'description' => esc_html__('Which element should be overlay?', 'burido-core'),
                'default' => 'row',
            ]
        );
