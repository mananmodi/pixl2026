...
class Wgl_Combo_Menu extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Wgl Combo Menu', 'burido-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'wgl_working_section',
			[
				'label' => esc_html__( 'Menu Content', 'burido-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
			    ...
			    'dynamic' => ['active' => true],
				'placeholder' => esc_html__( 'Combo Menu Title 1', 'burido-core' ),
				'default' => esc_html__( 'Combo Menu Title', 'burido-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
			    ...
			    'dynamic' => ['active' => true],
				'placeholder' => esc_html__( 'Menu Description', 'burido-core' ),
				'default' => esc_html__( 'Menu Description', 'burido-core' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
			    ...
			    'dynamic' => ['active' => true],
				'separator' => 'after',
				'placeholder' => esc_html__( '$3', 'burido-core' ),
				'default' => esc_html__( '$3', 'burido-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[ 'menu_title' => esc_html__( 'Combo Menu Title 1', 'burido-core' ) ],
					[ 'menu_title' => esc_html__( 'Combo Menu Title 2', 'burido-core' ) ],
					[ 'menu_title' => esc_html__( 'Combo Menu Title 3', 'burido-core' ) ],
				],
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => esc_html__( 'Styles', 'burido-core' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Image Styles', 'burido-core' ),
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .menu-item_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .menu-item:hover .menu-item_title' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Description Styles', 'burido-core' ),
                'separator' => 'before',
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .menu-item_desc' => 'color: {{VALUE}};',
                ],
            ]
        );
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Price Styles', 'burido-core' ),
                'separator' => 'before',
			]
		);
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'price_color!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .menu-item_price' => 'color: {{VALUE}};',
                ],
            ]
        );
		...
		$this->add_control(
			'sep_color',
			[
				'label' => esc_html__( 'Separator Between Color', 'burido-core' ),
				'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
        ...
        $this->add_control(
            'sep_color-dynamic',
            [
                'label' => esc_html__('Separator Between Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'sep_color!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .menu-item_content::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'sep_width',
            [
                'label' => esc_html__('Separator Min-Width', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'size_units' => ['px', '%', 'custom'],
                'range' => [
		...
		$this->start_controls_section(
			'items_style_section',
			[
				'label' => esc_html__( 'Items Styles', 'burido-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
            ...
            [
                ...
                'fields_options' => [
                    ...
                    'color' => [
                        ...
                        'default' => WGL_Globals::get_primary_color(0.3)
                    ],
                ],
                'selector' => '{{WRAPPER}} .menu-item',
            ]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Container Styles', 'burido-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
