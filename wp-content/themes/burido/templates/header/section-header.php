...
if (!class_exists('Burido_Get_Header')) {
    class Burido_Get_Header
    {
        ...
        public function header_bar_button($location = 'bottom', $k = null)
        {
            ...
            $button_css_id = uniqid('burido_button_');
        ...
        public function header_bar_socials($location = null)
        {
            ...
            $wrapper_id = uniqid('burido_wrapper_');
            ...
            foreach($socials as $social){
                ...
                if($social['enabled']){
                    ...
                    $social_css_id = uniqid('burido_social_');
        ...
        public function get_logo($menu_condition = false, $_prefix = '')
        {
            ...
            new Burido_Get_Logo($location, $menu_condition, $logo ?? '', $custom_size ?? '');
        }
        ...
        {
            $description = esc_html__('Type To Search', 'burido');
            ...
            $search_css_id = uniqid('burido_search_');
                    ...
                    echo '<div class="header_search-field">';
                        ...
                        echo '<form role="search" method="get" action="', esc_url(home_url('/')), '" class="search-form">',
                            '<input',
                                ...
                                ' class="search-field"',
                                ' placeholder="', esc_attr_x('Search &hellip;', 'placeholder', 'burido'), '"',
                                ' value="', get_search_query(), '"',
                                ' name="s"',
                                '>',
                            '<button class="search-button" type="submit" value="'.esc_attr__('Search', 'burido').'"><i class="search__icon">'.wgl_dynamic_styles()->wgl_theme_svg()['search'].'</i></button>',
                            $inputs,
                        '</form>';
                    echo '</div>';
                }
        ...
        public function get_side_panel_switcher()
        {
            echo '<div class="side_panel">',
                '<div class="side_panel_inner"', $this->side_panel_style_icon(), '>',
                    '<button class="side_panel-toggle" title="', esc_attr__('Open', 'burido'), '">',
            ...
            echo "<div class='login-in woocommerce'", $this->row_style_height($location), '>';
                ...
                echo '<span class="login-in_wrapper">';
                    if (is_user_logged_in()) {
                        echo "<a class='login-in_link-logout button' href='", esc_url($link_logout), "'><span class='button__content'>", esc_html__('Logout', 'burido'), "</span>";
                    } else {
                        echo "<a class='login-in_link button' href='", esc_url_raw($url), "'><span class='button__content'>", esc_html__('Login', 'burido'), '</span>';
                    }
        ...
        public function icon_cart()
        {
            ...
            $cart_css_id = uniqid('burido_woo_');
            ...
            $this->add_render_attribute('cart', 'title', esc_attr__('Click to open Shopping Cart', 'burido'));
