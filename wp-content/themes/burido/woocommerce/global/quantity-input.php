...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'burido' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'burido' );
...
<div class="quantity number-input<?php if ('hidden' === $type) echo ' wgl-number-input-hidden'; ?>">
    ...
    <div class="quantity-wrapper">
        ...
        <input
            ...
            aria-label="<?php esc_attr_e( 'Product quantity','burido' ); ?>"
