...
if (!class_exists( 'WGL_Posts_Widget')) {
	...
	class WGL_Posts_Widget extends WGL_Widgets_Helper {
		...
		function create_widget() {
			$args = [
				'label' => esc_html__( 'WGL Posts', 'burido-core' ),
		...
		public function widget($args, $instance) {
			...
			if ($recent_posts->have_posts()) { ?>
				...
				esc_html_e( 'No posts were found.', 'burido-core' );
			}
		...
		public function form_fields(){
            ...
            $categories_render[] = [
	            'name'  => esc_html__('All categories' , 'burido-core'),
	            'value' => 'all'
            ];
			...
			$args = [
				...
				[
					'name' => esc_html__('Number of posts', 'burido-core'),
					'id' => 'num_posts',
					'type' => 'number',
					'class' => 'tiny-text',
					'validate' => 'numeric',
				...
				[
					'name' => esc_html__('Filter by Category', 'burido-core'),
					'id' => 'categories',
					'type' => 'select',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Show related category posts', 'burido-core'),
					'id' => 'show_related',
					'type' => 'checkbox',
				...
				[
					'name' => esc_html__('Show thumbnail image', 'burido-core'),
					'id' => 'show_image',
					'type' => 'checkbox',
					'class' => 'widefat wgl_extensions_checkbox',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Show date', 'burido-core'),
					'id' => 'show_date',
					'type' => 'checkbox',
					'class' => 'widefat wgl_extensions_checkbox',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Show content', 'burido-core'),
					'id' => 'show_content',
					'type' => 'checkbox',
					'class' => 'widefat wgl_extensions_checkbox',
					'validate' => 'alpha_dash',
