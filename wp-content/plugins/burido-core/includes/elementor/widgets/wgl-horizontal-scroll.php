...
/**
 * This template can be overridden by copying it to `yourtheme[-child]/burido-core/elementor/widgets/wgl-horizontal-scroll.php`.
 */
...
class WGL_Horizontal_Scroll extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Horizontal Scroll', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'description' => esc_html__('This option helps to configure the widget. You will not see this title on the frontend.', 'burido-core'),
        ...
        $repeater->add_control(
            'bg_transition',
            array(
                'label'     => esc_html__('Background Transition', 'burido-core'),
        ...
        $repeater->add_control(
            'image',
            array(
                'label' => esc_html__('Choose Image', 'burido-core'),
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'label_off'    => __('Default', 'burido-core'),
                'label_on'     => __('Custom', 'burido-core'),
                'return_value' => 'yes',
                'condition'   => array(
                    'bg_transition' => 'yes',
                    'css_transform_animation!' => 'yes' 
        ...
        $this->add_control(
            ...
            [
                ...
                'title_field' => esc_html__('Template:', 'burido-core') . ' {{{ content_templates }}} - {{{ title }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'advanced_options',
            array(
                'label' => esc_html__('Advanced Options', 'burido-core'),
                'tab'   => Controls_Manager::TAB_CONTENT,
            )
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('CSS Transfom Animation', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_responsive_control(
            'item_spacingwrwerwerwer',
            [
                'label' => esc_html__( 'Spacing', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'range' => [
                    'vw' => ['min' => -100, 'max' => 100 ],
        ...
        $this->add_control(
            'bg_duration_change',
            [
                'label' => esc_html__('Change Transition', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'sticky_element',
            array(
                'label'     => esc_html__('Sticky Section', 'burido-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
                'default'   => '',
        ...
        $this->add_control(
            'sticky_template',
            array(
                'label'       => esc_html__('Select Template', 'burido-core'),
                'type'        => Controls_Manager::SELECT,
                'default'     => '0',
                'options'     => Wgl_Elementor_Helper::get_instance()->get_elementor_templates(),
                'label_block' => 'true',
        ...
        $this->add_control(
            'opacity_scroll',
            array(
                'label'     => esc_html__('Opacity Prev/Next Element', 'burido-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
                'default'   => '',
        ...
        $this->add_control(
            ...
            [
                ...
                'description'        => esc_html__('The first value sets the element’s original placement in the document. The second value controls how and where that element is displayed on screen during scrolling.', 'burido-core'),
                'type'               => Controls_Manager::SELECT,
                'separator'          => 'before',
                'default'            => 'default',
                'frontend_available' => true,
                'options'            => [
                    ...
                    'top top'       => esc_html__('Top on Top', 'burido-core'),
                    'top center'    => esc_html__('Top on Center', 'burido-core'),
                    'top bottom'    => esc_html__('Top on Bottom', 'burido-core'),
                    'center top'    => esc_html__('Center on Top', 'burido-core'),
                    'center center' => esc_html__('Center on Center', 'burido-core'),
                    'center bottom' => esc_html__('Center on Bottom', 'burido-core'),
                    'bottom top'    => esc_html__('Bottom on Top', 'burido-core'),
                    'bottom center' => esc_html__('Bottom on Center', 'burido-core'),
                    'bottom bottom' => esc_html__('Bottom on Bottom', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Custom', 'burido-core'),
                'type'               => Controls_Manager::TEXT,
                'default'            => esc_html__('top top', 'burido-core'),
                'description'        => esc_html__('You can write like: top top+=100', 'burido-core'),
                'frontend_available' => true,
                'render_type'        => 'none',
                'ai'                 => false,
                'condition'          => [
        ...
        $this->add_responsive_control(
            'h_scroll_speed',
            array(
                'label'       => esc_html__('Scroll Speed', 'burido-core'),
                'type'        => Controls_Manager::NUMBER,
                'min'         => 1,
                'max'         => 100,
                'step'        => 1,
        ...
        $this->add_responsive_control(
            'distance_last_slide',
            array(
                'label'       => esc_html__('Distance after last slide', 'burido-core'),
                'type'        => Controls_Manager::NUMBER,
                'min'         => 0,
                'max'         => 1000,
                'step'        => 10,
                'default'     => 0,
                'description' => esc_html__('Set the space (in pixels) after the final slide.', 'burido-core'),
                'separator'   => 'before',
                'condition' => [ 'css_transform_animation!' => 'yes' ],
            )
        );
        $this->add_control(
            'responsive_width',
            array(
                'label'     => esc_html__('Responsive Visibility', 'burido-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
                'default'   => 'no',
