...
class WGL_Video_Popup extends Widget_Base
{
    ...
    {
        return esc_html__( 'WGL Video Popup', 'burido-core' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'link',
            [
                'label' => esc_html__( 'Video Link', 'burido-core' ),
                'type' => Controls_Manager::TEXT,
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'description' => esc_html__( 'Link from youtube or vimeo.', 'burido-core' ),
                'placeholder' => esc_attr__( 'ex: https://www.youtube.com/watch?v=', 'burido-core' ),
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
                'placeholder' => esc_html__( 'Video Popup Title', 'burido-core' ),
            ]
        );
        ...
        $this->add_control(
            'title_position',
            [
                'label' => esc_html__( 'Title Position', 'burido-core' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'inline' => [
                        'title' => esc_html__( 'Inline', 'burido-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'scale' => esc_html__( 'Scale', 'burido-core' ),
                    'ring_static' => esc_html__( 'Static Ring', 'burido-core' ),
                    'ring_pulse' => esc_html__( 'Pulsing Ring', 'burido-core' ),
                    'circles' => esc_html__( 'Divergent Rings', 'burido-core' ),
                    'disable' => esc_html__( 'No animation', 'burido-core' ),
                ],
                'default' => 'scale',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Value', 'burido-core' ),
        ...
        $this->add_control(
            'anim_color',
            [
                'label' => esc_html__( 'Animation Element Color', 'burido-core' ),
        ...
        $this->add_control(
            'anim_color-dynamic',
            [
                'label' => esc_html__('Animation Element Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_animation' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .animation_ring_pulse .videobox_animation' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Run Animation Until Hover', 'burido-core' ),
        ...
        $this->add_control(
            'container_border_color_idle-dynamic',
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_content' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'container_border_color_hover-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_content:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    ...
                    'font_size' => [
                        ...
                        'tablet_default' => [ 'size' => 26, 'unit' => 'px' ],
        ...
        $this->add_control(
            'triangle_rounded',
            [
                'label' => esc_html__( 'Icon Rounded Corners', 'burido-core' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_responsive_control(
            'button_diameter',
            [
                'label' => esc_html__( 'Button Diameter', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'separator' => 'before',
                'range' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_link' => 'fill: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'icon_stroke_color_idle-dynamic',
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_link' => 'stroke: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_link::before' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'bg_color_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'bg_color_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .videobox_link::before' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
