...
if (!class_exists( 'WGL_Banner_Widget')) {
	...
	class WGL_Banner_Widget extends WGL_Widgets_Helper {
		...
		function create_widget() {
			$args = [
				'label' => esc_html__( 'WGL Banner', 'burido-core' ),
		...
		public function widget($args, $instance) {
			...
			if ( $logo ) {
				...
				if ( '' === get_post_meta( $attachment_id, '_wp_attachment_image_alt', true ) ) {
					$logo_alt = the_title_attribute( [
						'before' => esc_html__( 'Featured image: ', 'burido-core' ),
						'echo' => false
					] );
				} else {
			...
			// Render ?>
            <div class="burido_banner-widget burido_widget widget<?php echo esc_attr($widgetClass); ?>">
		...
		public function form_fields(){
			$args = [
				[
					'name' => esc_html__('Logo image', 'burido-core'),
					'id' => 'logo',
					'type' => 'media_image',
                ...
                [
                    'name' => esc_html__('Default Logo Height', 'burido-core'),
                    'id' => 'logo_height',
                    'type' => 'text',
                    'class' => 'widefat',
                    'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Padding Top', 'burido-core'),
					'id' => 'padding_top',
					'type' => 'text',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Padding Bottom', 'burido-core'),
					'id' => 'padding_bottom',
					'type' => 'text',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Sub Title', 'burido-core'),
					'id' => 'subtitle',
					'type' => 'textarea',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Button Text', 'burido-core'),
					'id' => 'button_text',
					'type' => 'text',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Banner URL', 'burido-core'),
					'id' => 'banner_url',
					'type' => 'text',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
