...
class WGL_Header_Search extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Search', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'search_style',
            [
                'label' => esc_html__('Choose Search Style', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'standard' => esc_html__( 'Standard', 'burido-core' ),
                    'simple' => esc_html__( 'Simple', 'burido-core' ),
                    'standard_fw' => esc_html__( 'Full Header Width', 'burido-core' ),
                    'alt' => esc_html__( 'Full Page Width', 'burido-core' ),
                ],
                'default' => 'standard',
            ]
        );
        ...
        $this->add_control(
            'search_post_type',
            [
                'label' => esc_html__('Search Post Types', 'burido-core'),
        ...
        $this->add_control(
            'input_color',
            [
                'label' => esc_html__('Input Text Color', 'burido-core'),
        ...
        $this->add_control(
            'input_color-dynamic',
            [
                'label' => esc_html__('Input Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .header_search .header_search-field .search-field' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'input_icon_color',
            [
                'label' => esc_html__('Input Icon Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => ['search_style!' => 'alt'],
                'selectors' => [
        ...
        $this->add_control(
            'input_icon_color-dynamic',
            [
                'label' => esc_html__('Input Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .header_search .header_search-field .search__icon' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'input_bg_color',
            [
                'label' => esc_html__('Input Background Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => ['search_style!' => 'alt'],
                'selectors' => [
        ...
        $this->add_control(
            'input_bg_color-dynamic',
            [
                'label' => esc_html__('Input Background - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .header_search .header_search-field .search-field' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'search_bg_color',
            [
                'label' => esc_html__('Search Background Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
        ...
        $this->add_control(
            'search_bg_color-dynamic',
            [
                'label' => esc_html__('Search Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .header_search .header_search-field' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Search Icon', 'burido-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .header_search-button' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .header_search-button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-search:hover .header_search-button' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .wgl-search:hover .header_search-button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-search:hover .header_search-button' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->start_controls_section(
            'section_style_close',
            [
                'label' => esc_html__('Close Icon', 'burido-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'icon_close_color_idle-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'icon_close_color_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .search_standard .header_search-close' => 'color: {{VALUE}}'
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'icon_close_bg_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'icon_close_bg_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .search_standard .header_search-close' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            'icon_close_color_hover-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'icon_close_color_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .search_standard .header_search-close:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'icon_close_bg_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'icon_close_bg_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .search_standard .header_search-close:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_tab();
    ...
    public function render()
    {
        ...
        $description = esc_html__('Type To Search', 'burido-core');
        $search_style = $_s['search_style'] ?? 'standard';
        $search_counter = null;
        $unique_id = uniqid('search-form-');

        if (class_exists('\Burido_Get_Header')) {
            $search_counter = \Burido_Get_Header::$search_form_counter ?? null;
        }
        ...
        if ($search_style === 'alt') {
            ...
            if (isset($search_counter)) \Burido_Get_Header::$search_form_counter++;
        }
            ...
            if ($render_search) { ?>
                ...
                echo '<form role="search" method="get" action="', esc_url(home_url('/')), '" class="search-form">',
                    '<input',
                        ...
                        ' class="search-field"',
                        ' placeholder="', esc_attr_x('Search &hellip;', 'placeholder', 'burido-core'), '"',
                        ' value="', get_search_query(), '"',
                        ' name="s"',
                        '>',
                    '<input class="search-button" type="submit" value="', esc_attr__('Search', 'burido-core'), '">',
                    $inputs;
