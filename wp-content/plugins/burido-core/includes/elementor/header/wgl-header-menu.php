...
class WGL_Header_Menu extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Menu', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'template',
            [
                'label' => esc_html__('Template', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__('Theme Default', 'burido-core'),
                    'custom' => esc_html__('WordPress Menu', 'burido-core'),
                    'custom_item' => esc_html__('Custom', 'burido-core'),
                ],
                'default' => 'default',
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'menu' => esc_html__('Menu', 'burido-core'),
                    'submenu' => esc_html__('Sub Menu', 'burido-core'),
                ],
                'default' => 'menu',
            ]
        );
        ...
        $repeater->add_control(
            'item_position',
            [
                'label' => esc_html__('Dropdown Position', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'item_text' => esc_html__('Text', 'burido-core'),
                    ],
                ],
        ...
        $this->add_control(
            'menu',
            [
                'label' => esc_html__('Menu', 'burido-core'),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'submenu_disable',
            [
                'label' => esc_html__('Disable Submenu', 'burido-core'),
        ...
        $this->add_control(
            'marker_disable',
            [
                'label' => esc_html__('Disable Marker', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
            ]
        ...
        $this->add_control(
            'vertical_menu',
            [
                'label' => esc_html__('Vertical Menu', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
                'selectors' => [
        ...
        $this->add_control(
            'expand_menu',
            [
                'label' => esc_html__('Expand menu on item click', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
                'return_value' => 'expand',
        ...
        $this->add_control(
            'lavalamp_active',
            [
                'label' => esc_html__('Lavalamp Marker', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'burido-core'),
                'label_off' => esc_html__('Off', 'burido-core'),
                'condition' => ['vertical_menu' => ''],
        ...
        $this->add_control(
            'menu_height',
            [
                'label' => esc_html__('Module Height (px)', 'burido-core'),
        ...
        if('elementor' === \WGL_Framework::get_option('mobile_header_building_tool')){
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Dropdown Breakpoint', 'burido-core'),
        ...
        $this->add_responsive_control(
            'menu_padding',
            [
                'label' => esc_html__('Menu Padding', 'burido-core'),
        ...
        $this->add_responsive_control(
            'menu_items_padding',
            [
                'label' => esc_html__('Items Padding', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%', 'custom' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Items Inner Padding', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%', 'custom' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'menu_items_margin',
            [
                'label' => esc_html__('Items Margin', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%', 'custom' ],
                'selectors' => [
        ...
        $this->add_control(
            'menu_text_idle-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_text_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li > a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'menu_bg_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_bg_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'menu_border_idle-dynamic',
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_icon_idle-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_icon_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a > .menu-item__plus' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_marker_idle',
            [
                'label' => esc_html__('Marker Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => ['marker_disable' => ''],
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li > a .menu-item_dots' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'menu_marker_idle-dynamic',
            [
                'label' => esc_html__('Marker Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a .menu-item_dots' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_text_hover-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_text_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover > a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li:hover > a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'menu_bg_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_bg_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover > a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [ 'border_border!' => '' ],
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'menu_border_hover-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_icon_hover-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_icon_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover > a > .menu-item__plus' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => ['marker_disable' => ''],
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li:hover > a .menu-item_dots' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'menu_marker_hover-dynamic',
            [
                'label' => esc_html__('Marker Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover > a .menu-item_dots' => 'color: {{VALUE}};',
                ],
            ]
        );
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li[class*="current"] > a,
                     {{WRAPPER}} .primary-nav > ul > li > a.active' => 'color: {{VALUE}}',
                ],

            ]
        );
        $this->add_control(
            'menu_text_active-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_text_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"] > a,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li[class*="current"] > a,
                     {{WRAPPER}} .primary-nav > ul > li > a.active' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'menu_bg_active-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_bg_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"] > a,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li[class*="current"] > a,
                     {{WRAPPER}} .primary-nav > ul > li > a.active' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'menu_border_active-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"] > a,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_icon_active-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_icon_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"] > a > .menu-item__plus,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active > span > .menu-item__plus' => 'color: {{VALUE}}',
                ],
            ]
        );
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .primary-nav > ul > li[class*="current"] > a .menu-item_dots,
                     {{WRAPPER}} .primary-nav > ul > li > a.active > span .menu-item_dots' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'menu_marker_active-dynamic',
            [
                'label' => esc_html__('Marker Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_marker_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"] > a .menu-item_dots,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active > span .menu-item_dots' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submenu', 'burido-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'submenu_radius',
            [
                'label' => esc_html__('Container Border Radius', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Items Border Radius', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'custom'],
                'selectors' => [
        ...
        $this->add_control(
            'submenu_text_idle-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_text_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_bg_idle-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_bg_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li  ul.sub-menu' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_bg_item_idle-dynamic',
            [
                'label' => esc_html__('Item Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_bg_item_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li  ul.sub-menu li > a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_icon_idle-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_icon_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li:not(:hover) > a > .menu-item__plus' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_text_hover-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_text_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li:hover > a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_bg_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_bg_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover ul.sub-menu' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_bg_item_hover-dynamic',
            [
                'label' => esc_html__('Item Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_bg_item_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li  ul.sub-menu  li:hover > a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_icon_hover-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_icon_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li:hover > a > .menu-item__plus' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_text_active-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_text_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li[class*="current"]:not(:hover) > a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_bg_active-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_bg_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"]:not(:hover)  ul.sub-menu' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_bg_item_active-dynamic',
            [
                'label' => esc_html__('Item Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_bg_item_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li[class*="current"]:not(:hover) > a' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_icon_active-dynamic',
            [
                'label' => esc_html__('Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_icon_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li[class*="current"]:not(:hover) > a > .menu-item__plus' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .primary-nav ul li > ul.sub-menu ul.sub-menu' => 'padding-top: {{TOP}}{{UNIT}}; padding-bottom: {{BOTTOM}}{{UNIT}};padding-left: {{LEFT}}{{UNIT}}; padding-right: {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Container Margin', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'separator' => 'before',
                'size_units' => [ 'px', 'em' ],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Menu Icon Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'menu_icon_color_idle-dynamic',
            [
                'label' => esc_html__('Menu Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_icon_color_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a .content__media' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a .content__media svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Submenu Icon Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'submenu_icon_color_idle-dynamic',
            [
                'label' => esc_html__('Submenu Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_icon_color_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu > a .content__media' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu > a .content__media svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_icon_color_hover-dynamic',
            [
                'label' => esc_html__('Menu Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_icon_color_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover > a .content__media' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li:hover > a .content__media svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_icon_color_hover-dynamic',
            [
                'label' => esc_html__('Submenu Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_icon_color_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li:hover > a .content__media' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li:hover > a .content__media svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'menu_icon_color_active-dynamic',
            [
                'label' => esc_html__('Menu Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'menu_icon_color_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"]:not(:hover) > a .content__media,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active > span > .content__media' => 'color: {{VALUE}}',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li[class*="current"]:not(:hover) > a .content__media svg,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a.active > span > .content__media svg' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'submenu_icon_color_active-dynamic',
            [
                'label' => esc_html__('Submenu IconColor - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'submenu_icon_color_active!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li[class*="current"]:not(:hover) > a > .content__media' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav ul li ul.sub-menu li[class*="current"]:not(:hover) > a > .content__media svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'menu_icon_spacing',
            [
                'label' => esc_html__('Horizontal Gap', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => ['min' => 0, 'max' => 100],
        ...
        $this->add_responsive_control(
            'menu_icon_v_spacing',
            [
                'label' => esc_html__('Vertical Gap', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => ['min' => 0, 'max' => 100],
        ...
        $this->add_control(
            'lavalamp_color-dynamic',
            [
                'label' => esc_html__('Lavalamp Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'lavalamp_color!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .lavalamp-object' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        if('elementor' === \WGL_Framework::get_option('mobile_header_building_tool')){
            ...
            $this->add_responsive_control(
                'switcher_v_position',
                [
                    'label' => esc_html__('Switcher Vertical Position', 'burido-core'),
                    'type' => Controls_Manager::SLIDER,
                    'dynamic' => ['active' => true],
                    'size_units' => [ 'px', 'em', '%', 'custom' ],
                    'selectors' => [
            ...
            $this->add_responsive_control(
                'switcher_h_position',
                [
                    'label' => esc_html__('Switcher Horizontal Position', 'burido-core'),
                    'type' => Controls_Manager::SLIDER,
                    'dynamic' => ['active' => true],
                    'size_units' => [ 'px', 'em', '%', 'custom' ],
                    'selectors' => [
            ...
            $this->add_control(
                'menu_switcher_idle',
                [
                    'label' => esc_html__('Switcher Color', 'burido-core'),
                    'type' => Controls_Manager::COLOR,
                    'dynamic' => ['active' => true],
                    'selectors' => [
            ...
            $this->add_control(
                'menu_switcher_idle-dynamic',
                [
                    'label' => esc_html__('Switcher Color - Dynamic', 'burido-core'),
                    'type' => Controls_Manager::COLOR,
                    'separator' => 'after',
                    'dynamic' => ['active' => true],
                    'condition' => [ 'menu_switcher_idle!' => '' ],
                    'selectors' => [
                        'body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a .button_switcher_vertical:before,
                         body.wgl_dynamic_colors-active {{WRAPPER}} .primary-nav > ul > li > a .button_switcher:before' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                'dropdown_color',
                [
                    'label' => esc_html__('Dropdown Color', 'burido-core'),
                    'type' => Controls_Manager::COLOR,
                    'dynamic' => ['active' => true],
                    'selectors' => [
