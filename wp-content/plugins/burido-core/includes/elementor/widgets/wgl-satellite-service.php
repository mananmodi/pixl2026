...
class WGL_Satellite_Service extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Satellite Service', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $output[ 'media_width' ] = [
            'label' => esc_html__('Media Width (Height)', 'burido-core'),
        ...
        $this->add_control(
            'ib_content',
            [
                'label' => esc_html__('Service Text', 'burido-core'),
                'type' => Controls_Manager::WYSIWYG,
			    'dynamic' => ['active' => true],
                'label_block' => true,
				'placeholder' => esc_attr__('Description Text', 'burido-core'),
                'default' => esc_html__('Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'burido-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_style_link',
            [ 'label' => esc_html__('Service Link', 'burido-core') ]
        );
        ...
        $this->add_control(
            'primary_color',
            [
                'label' => esc_html__('Primary Color', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Primary Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
        ...
        $this->add_control(
            'hover_primary_color-dynamic',
            [
                'label' => esc_html__('Primary Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['hover_primary_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .wgl-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'border_type',
            [
                'label' => esc_html__('Border Type', 'Border Control', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => esc_html__('Solid', 'Border Control', 'burido-core'),
                    'double' => esc_html__('Double', 'Border Control', 'burido-core'),
                    'dotted' => esc_html__('Dotted', 'Border Control', 'burido-core'),
                    'dashed' => esc_html__('Dashed', 'Border Control', 'burido-core'),
                    'groove' => esc_html__('Groove', 'Border Control', 'burido-core'),
                ],
                'default' => 'dashed',
                'selectors' => [
        ...
        $this->add_control(
            'border_primary_color-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['border_primary_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_media-wrap' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'border_hover_primary_color-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['border_hover_primary_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .wgl-services_media-wrap' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'circle_width',
            [
                'label' => esc_html__('Circles Width(Height)', 'burido-core'),
                'type' => Controls_Manager::NUMBER,
			    'dynamic' => ['active' => true],
                'min' => 2,
                'step' => 1,
        ...
        $this->add_control(
            'circle_color_1',
            [
                'label' => esc_html__('First Circle Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'circle_color_1-dynamic',
            [
                'label' => esc_html__('First Circle Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['circle_color_1!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_circle-wrapper:nth-child(1) .wgl-services_circle' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'circle_color_2',
            [
                'label' => esc_html__('Second Circle Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'circle_color_2-dynamic',
            [
                'label' => esc_html__('Second Circle Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['circle_color_2!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_circle-wrapper:nth-child(2) .wgl-services_circle' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'title_offset',
            [
                'label' => esc_html__('Title Offset', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'default' => [
                    'top' => '15',
                    'right' => '0',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .wgl-services_title' => 'color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .wgl-services_title a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'content_offset',
            [
                'label' => esc_html__('Content Offset', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', 'em', '%', 'custom' ],
                'default' => [
                    'top' => '0',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .wgl-services_text' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            'button_background-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['button_background!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_readmore' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'button_color-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['button_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_readmore' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'button_background_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['button_background_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_readmore:hover' => 'background: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_readmore:hover' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            'bg_service_2_color-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['bg_service_2_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_wrap' => 'background-color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            'bg_service_2_color_hover-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['bg_service_2_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}}:hover .wgl-services_wrap' => 'background-color: {{VALUE}};'
                ],
            ]
        );
