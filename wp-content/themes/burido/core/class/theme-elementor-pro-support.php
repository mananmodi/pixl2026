...
if ( ! class_exists( 'Burido_Theme_ElementorPro_Support' ) ) {
    /**
     ...
     * @since 1.0.0
     */
    class Burido_Theme_ElementorPro_Support
    {
        ...
        {
            add_action( 'init', [ $this, 'burido_init_template' ] );
        }
        ...
        public function burido_init_template()
        {
    ...
    new Burido_Theme_ElementorPro_Support();
}
