...
class WGLCountDown
{
	...
	public function render($self, $atts)
	{
		...
		$data['labels'][]  = esc_html__('Years', 'burido-core');
		$data['labels'][]  = esc_html__('Months', 'burido-core');
		$data['labels'][]  = esc_html__('Weeks', 'burido-core');
		$data['labels'][]  = esc_html__('Days', 'burido-core');
		$data['labels'][]  = esc_html__('Hours', 'burido-core');
		$data['labels'][]  = esc_html__('Minutes', 'burido-core');
		$data['labels'][]  = esc_html__('Seconds', 'burido-core');
		$data['labels1'][] = esc_html__('Year', 'burido-core');
		$data['labels1'][] = esc_html__('Month', 'burido-core');
		$data['labels1'][] = esc_html__('Week', 'burido-core');
		$data['labels1'][] = esc_html__('Day', 'burido-core');
		$data['labels1'][] = esc_html__('Hour', 'burido-core');
		$data['labels1'][] = esc_html__('Minute', 'burido-core');
		$data['labels1'][] = esc_html__('Second', 'burido-core');
