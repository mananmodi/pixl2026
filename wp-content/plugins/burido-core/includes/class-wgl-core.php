...
class Burido_Core
{
     ...
     * @since 1.0.0
     * @access protected
     * @var Burido_Core_Loader $loader Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - Burido_Core_Loader. Orchestrates the hooks of the plugin.
     * - Burido_Core_i18n. Defines internationalization functionality.
     * - Burido_Core_Admin. Defines all hooks for the admin area.
     *
    ...
    private function load_dependencies()
    {
        ...
        $this->loader = new Burido_Core_Loader();
    }
     ...
     *
     * Uses the Burido_Core_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since 1.0.0
     * @access private
    ...
    {
        $plugin_i18n = new Burido_Core_i18n();
    ...
    private function add_filters()
    {
        ...
        add_filter('attachment_fields_to_edit', function($form_fields, $post) {
            $form_fields['custom_image_link'] = array(
                'label' => esc_html__( 'Custom Image Link', 'burido-core' ),
                'input' => 'text',
                'value' => get_post_meta($post->ID, 'custom_image_link', true),
                'helps' => esc_html__( 'This option works only for the WGL Gallery module.', 'burido-core' ),
            );
     ...
     *
     * @since 1.0.0
     * @return Burido_Core_Loader Orchestrates the hooks of the plugin.
     */
