...
class WGL_Zoom extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Scroll Animation', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'speed',
            [
                'label' => esc_html__('Animation Section Size', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'render_type' => 'template',
                'options' => [
                    '0' => esc_html__('Default (is equal to 2vh)', 'burido-core'),
                    '1' => esc_html__('3vh', 'burido-core'),
                    '2' => esc_html__('4vh', 'burido-core'),
                    '3' => esc_html__('5vh', 'burido-core'),
                    '4' => esc_html__('6vh', 'burido-core'),
                    '5' => esc_html__('7vh', 'burido-core'),
                ],
                'default' => '0',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label' => esc_html__( 'Items Height', 'burido-core' ),
        ...
        $repeater->add_control(
            'time_from',
            [
                'label' => esc_html__( 'Starting Animation Point on Screen', 'burido-core' ),
                'description' => esc_html__( 'Vertical position on the screen when all animation effects are applied to the current item( 0 - middle of a screen, 100 - very bottom, -100 - top of a screen)', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'range' => [
        ...
        $repeater->add_responsive_control(
            ...
            [
                ...
                'description' => esc_html__( 'We recommend not using blur on tablet and mobile devices for better animation playback.', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
        ...
        $repeater->add_control(
            'time_to',
            [
                'label' => esc_html__( 'Ending Animation Point on Screen', 'burido-core' ),
                'description' => esc_html__( 'Vertical endpoint position on the screen for applying all animation effects (0 - middle of the screen, 100 - very bottom, -100 - top of the screen)', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => -100, 'max' => 200, 'step' => 1 ],
        ...
        $repeater->add_responsive_control(
            'bg_scale_from',
            [
                'label' => esc_html__( 'Background Scale From', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'separator' => 'before',
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
        ...
        $repeater->add_responsive_control(
            'bg_scale_to',
            [
                'label' => esc_html__( 'Background Scale To', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
                'range' => [
        ...
        $repeater->add_control(
            'bg_opacity_from',
            [
                'label' => esc_html__( 'Background Opacity From', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'separator' => 'before',
                'range' => [
        ...
        $repeater->add_control(
            'bg_opacity_to',
            [
                'label' => esc_html__( 'Background Opacity To', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
                'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => 0, 'max' => 1, 'step' => 0.01 ],
        ...
        $this->add_control(
            'item_overflow',
            [
                'label' => esc_html__('Item Overflow', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    ...
                    'overflow: clip;' => esc_html__('Clip', 'burido-core'),
                ],
                'selectors' => [
