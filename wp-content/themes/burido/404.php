...
if (
    ...
    $error_text_repeat = '<span>' . esc_html__('error 404', 'burido') . '</span>';
                        ...
                        <div class="error_page row">
                            <div class="wgl_col-12">
                                ...
                                <h2 class="error_page__title"><?php
                                    esc_html_e('Lost in cyberspace: 404 edition', 'burido'); ?>
                                </h2>

                                <p class="error_page__description"><?php
                                    esc_html_e('The page you are looking for was moved, removed, renamed or never existed.', 'burido'); ?>
                                </p>

                                <div class="burido_404_search"><?php
                                    get_search_form(); ?>
                                </div>

                                <div class="burido_404__button elementor-widget-wgl-button has-magnetic">
                                    <a class="wgl-button btn-size-xl" data-magnetic-threshold="100" data-magnetic-strong="0.3" href="<?php echo esc_url(home_url('/')); ?>" role="button">
                                        <div class="button__content">
                                            <span class="button__text"><?php
                                                esc_html_e('Back to Home', 'burido'); ?>
                                            </span>
                                        </div>
                                    </a>
                                </div>
