...
class WGL_Header_Delimiter extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Delimiter', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'delimiter_height',
            [
                'label' => esc_html__('Delimiter Height', 'burido-core'),
        ...
        $this->add_control(
            'delimiter_width',
            [
                'label' => esc_html__('Delimiter Width', 'burido-core'),
                'type' => Controls_Manager::NUMBER,
			    'dynamic' => ['active' => true],
                'min' => 0,
                'default' => 1,
                'description' => esc_html__('Values in pixels', 'burido-core'),
                'selectors' => [
