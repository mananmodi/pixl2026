...
if ( ! class_exists( 'WGL_Framework_Global_Variables' ) ) {
    ...
    class WGL_Framework_Global_Variables
    {
        ...
        protected function set_variables()
        {
            ...
            self::$static_color = esc_attr( WGL_Framework::get_option( 'theme-static-color' ) );
        ...
        public static function get_static_color( $opacity = null )
        {
            if ( is_numeric( $opacity ) ) {
                return self::get_opaqued_rgba_color( self::$static_color, $opacity );
            }
