        ...
        public function post_share()
        {
            ...
            if ($shares['telegram']) {
                echo '<a class="share_link share_telegram"',
                    ...
                    esc_html__('Telegram', 'burido-core'),
                    '</span>',
                    '</span>',
                    '</a>';
            }
            ...
            if ($shares['whatsapp']) {
                echo '<a class="share_link share_whatsapp"',
                    ...
                    '<span class="share_name">',
                    esc_html__('Whatsapp', 'burido-core'),
                    '</span>',
                    '</span>',
                    '</a>';
            }
            ...
            if ($shares['twitter']) {
                echo '<a class="share_link share_twitter"',
                    ...
                    '<span class="share_name">',
                    esc_html__('Twitter', 'burido-core'),
                    '</span>',
                    '</span>',
                    '</a>';
            }
            ...
            if ($shares['facebook']) {
                echo '<a class="share_link share_facebook"',
                    ...
                    '<span class="share_name">',
                    esc_html__('Facebook', 'burido-core'),
                    '</span>',
                    '</span>',
                    '</a>';
            }
            ...
            if ($shares['pinterest'] && $img_url) {
                echo '<a class="share_link share_pinterest"',
                    ...
                    '<span class="share_name">',
                    esc_html__('Pinterest', 'burido-core'),
                    '</span>',
                    '</span>',
                    '</a>';
            }
            ...
            if ($shares['linkedin']) {
                echo '<a class="share_link share_linkedin"',
                    ...
                    '<span class="share_name">',
                    esc_html__('Linkedin', 'burido-core'),
                    '</span>',
                    '</span>',
                    '</a>';
            };
        ...
        public function page_social_shares()
        {
            ...
            if ('hovered' === $visibility) {
                echo '<div class="socials__desc">',
                    ...
                    apply_filters('wgl_theme/socials/description', esc_html__('Socials', 'burido-core')),
                    '</span>',
                    '</div>';
            }
            ...
            if ($facebook) {
                echo '<li>',
                    ...
                    ' target="_blank"',
                    '>',
                    '<span class="social__icon"><i class="fab fa-facebook-f"></i></span>',
                    '<span class="social__name">',
                    esc_html__('Facebook', 'burido-core'),
                    '</span>',
                    '</a>',
