...
class Wgl_Tabs_Horizontal extends Widget_Base {
	...
	public function get_title() {
		return esc_html__('WGL Tabs Horizontal', 'burido-core');
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
			    ...
			    'dynamic' => ['active' => true],
                'label_block' => true,
				'placeholder' => esc_html__('/', 'burido-core'),
			]
		);
		$repeater->add_control(
			'tabs_tab_icon_type',
        ...
        $this->add_control(
            'sticky_heading',
            [
                'label' => esc_html__('Sticky Heading', 'burido-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Heading Position', 'burido-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'row' => esc_html__('Left', 'burido-core'),
                    'column' => esc_html__('Top', 'burido-core'),
                ],
                'default' => 'row',
        ...
        $this->add_responsive_control(
            'tabs_heading_width',
            [
                'label' => esc_html__('Heading Width', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'effect-fade' => esc_html__('Fade', 'burido-core'),
                    'effect-slide' => esc_html__('Slide', 'burido-core'),
                ],
                'default' => 'effect-fade',
            ]
        );
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Titles Wrapper', 'burido-core'),
        ...
        $this->add_control(
            'titles_wrapper_bg-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['titles_wrapper_bg!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_headings' => 'background-color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_section();
        ...
        $this->add_control(
            't_title_color_idle-dynamic',
            [
                'label' => esc_html__('Title Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['t_title_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            't_title_bg_color_idle-dynamic',
            [
                'label' => esc_html__('Title Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['t_title_bg_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => [ 'tabs_tab_stroke_size[size]!' => '' ],
                'selectors' => [
        ...
        $this->add_control(
            't_title_stroke_color_idle-dynamic',
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'tabs_tab_stroke_size[size]!' => '',
                    't_title_stroke_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap:hover .wgl-tabs-horizontal_header' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            't_title_stroke_color_hover-dynamic',
            [
                'label' => esc_html__('Stroke Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap:hover .wgl-tabs-horizontal_header' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap.active .wgl-tabs-horizontal_header' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap.active' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            't_title_stroke_color_active-dynamic',
            [
                'label' => esc_html__('Stroke Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap.active .wgl-tabs-horizontal_header' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_group_control(
        ...
        $this->add_control(
            'tabs_prefix_color-dynamic',
            [
                'label' => esc_html__('Prefix Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['tabs_prefix_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_prefix' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
        ...
        $this->add_control(
            'tabs_prefix_color_hover-dynamic',
            [
                'label' => esc_html__('Prefix Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['tabs_prefix_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap:hover .wgl-tabs-horizontal_prefix' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
        ...
        $this->add_control(
            'tabs_prefix_color_active-dynamic',
            [
                'label' => esc_html__('Prefix Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['tabs_prefix_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap.active .wgl-tabs-horizontal_prefix' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap:hover .wgl-tabs-horizontal_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_header_wrap.active .wgl-tabs-horizontal_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_content-wrap' => 'color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-tabs-horizontal_content-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'tabs_tab_lavalamp_enabled' => 'yes',
                    'tabs_lavalamp_color_active!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .lavalamp-object::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_section();
