...
class Wgl_Time_Line_Horizontal extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Time Line Horizontal', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'initial_slide',
            [
                'label' => esc_html__('Index Number of Initial Slide', 'burido-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Arrows Vertical Position', 'burido-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Arrows Horizontal Position', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    '%' => [ 'min' => -10, 'max' => 50 ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Shift the Center of the Buttons Position', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'size_units' => [ '%', 'vw', 'custom'],
                'condition' => [ 'use_navigation!' => '' ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Dots Vertical Position', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => -100, 'max' => 600 ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Dots Horizontal Position', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    '%' => [ 'min' => -10, 'max' => 110 ],
        ...
        $this->add_control(
            'date_overflow',
            [
                'label' => esc_html__('The overflow of Date Section is clipped?', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'selectors' => [
        ...
        $this->add_control(
            'content_overflow',
            [
                'label' => esc_html__('The overflow of Content Section is clipped?', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'selectors' => [
        ...
        $this->add_responsive_control(
            'date_section_width',
            [
                'label' => esc_html__('Date Section Width', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => 80, 'max' => 500 ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Content Section Width', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => 200, 'max' => 1920 ],
        ...
        $this->add_responsive_control(
            'content_section_gap',
            [
                'label' => esc_html__('Content Section Gap', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [ 'px' => [ 'max' => 60 ] ],
                'size_units' => [ 'px', 'custom'],
        ...
        $this->add_responsive_control(
            'circle_size',
            [
                'label' => esc_html__('Dots Size', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => 5,'max' => 80 ],
        ...
        $this->add_responsive_control(
            'circle_size_active',
            [
                'label' => esc_html__('Dots Size Active', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => 5,'max' => 80 ],
        ...
        $this->add_responsive_control(
            'circle_margin',
            [
                'label' => esc_html__('Dots Margin', 'burido-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Dots Border Radius', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'custom' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'date_padding',
            [
                'label' => esc_html__('Date Padding', 'burido-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'default' => [
                    'top' => '0',
                    'right' => '5',
        ...
        $this->add_control(
            'date_color_idle-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['date_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-time_line-date' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                'label' => esc_html__('Dots Background Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'circle_bg_color_idle-dynamic',
            [
                'label' => esc_html__('Dots Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['circle_bg_color_idle!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-time_line-dot::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'circle_border_color_idle-dynamic',
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'circle_border_border!' => ['', 'none'],
                    'circle_border_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-time_line-dot::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'date_border_color',
            [
                'label' => esc_html__('Date Border Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'date_border_color-dynamic',
            [
                'label' => esc_html__('Date Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['date_border_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date::before,
	                 body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'date_color_hover-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['date_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date:hover .wgl-time_line-date' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'circle_bg_color_hover-dynamic',
            [
                'label' => esc_html__('Dots Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['circle_bg_color_hover!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date:hover .wgl-time_line-dot::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'circle_border_color_hover-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date:hover .wgl-time_line-dot::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            'date_color_active-dynamic',
            [
                'label' => esc_html__('Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['date_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date.slide-active .wgl-time_line-date' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'circle_bg_color_active-dynamic',
            [
                'label' => esc_html__('Dots Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['circle_bg_color_active!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date.slide-active .wgl-time_line-dot::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'circle_border_color_active-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-date.slide-active .wgl-time_line-dot::after' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-content_wrap:hover .time_line_h-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-content_inner' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-content_wrap:hover .time_line_h-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .time_line_h-content_wrap:hover .time_line_h-content_inner' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
	    ...
	    ?><div <?php echo $this->get_render_attribute_string( 'timeline-horizontal' ); ?>>
            ...
            if ($_s['use_navigation']) { ?>
                <div class="wgl-navigation_wrapper">
                    <button class="elementor-swiper-button elementor-swiper-button-prev" data-carousel="<?php echo esc_attr($carousel_id); ?>"><i class="wgl-svg-icon"><?php echo wgl_dynamic_styles()->wgl_theme_svg()['arrow-down-right']; ?></i></button>
                    <button class="elementor-swiper-button elementor-swiper-button-next" data-carousel="<?php echo esc_attr($carousel_id); ?>"><?php echo wgl_dynamic_styles()->wgl_theme_svg()['arrow-down-right']; ?></i></button>
                </div><?php
            }
