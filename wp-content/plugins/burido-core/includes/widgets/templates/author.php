...
if (!class_exists( 'WGL_Author_Widget')) {
	...
	class WGL_Author_Widget extends WGL_Widgets_Helper {
		...
		function create_widget() {
			$args = [
				'label' => esc_html__( 'WGL Blog Author', 'burido-core' ),
				'description' => esc_html__( 'WGL Widget', 'burido-core' ),
			];
		...
		public function widget($args, $instance) {
			...
			if ($author_image_url) {
				...
				if ( '' === get_post_meta( $attachment_id, '_wp_attachment_image_alt', true ) ) {
					$alt = the_title_attribute( [
						'before' => esc_html__( 'Featured author image: ', 'burido-core' ),
						'echo' => false
					] );
				} else {
            ...
            if ($image_signature) {
	            ...
	            if ( '' === get_post_meta( $attachment_id_s, '_wp_attachment_image_alt', true ) ) {
		            $alt_s = the_title_attribute( [
			            'before' => esc_html__( 'Featured author signature: ', 'burido-core' ),
			            'echo' => false
		            ] );
	            } else {
			...
			// Render ?>
			<div class="widget burido_widget widget_author"><?php
			...
			if ($author_image_url) {
				?><img class="author-widget_img" src="<?php echo esc_url(aq_resize($author_image_url, '540', '900', true, true, true)); ?>" alt="<?php echo esc_attr($alt); ?>"><?php
			}
		...
		public function form_fields(){
			$args = [
				[
					'name' => esc_html__('Title', 'burido-core'),
					'desc' => esc_html__('Enter the widget title.', 'burido-core'),
					'id' => 'title',
					'type' => 'text',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Author Name', 'burido-core'),
					'id' => 'name',
					'type' => 'text',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Text', 'burido-core'),
					'id' => 'text',
					'type' => 'textarea',
					'class' => 'widefat',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Author Image', 'burido-core'),
					'id' => 'image',
					'type' => 'media_image',
				...
				[
					'name' => esc_html__('Background Image', 'burido-core'),
					'id' => 'bg_image',
					'type' => 'media_image',
					'class' => 'widefat wgl_extensions_media_url',
					'validate' => 'alpha_dash',
				...
				[
					'name' => esc_html__('Thumbnail', 'burido-core'),
					'id' => 'signature',
					'type' => 'media_image',
					'class' => 'widefat wgl_extensions_media_url',
					'validate' => 'alpha_dash',
