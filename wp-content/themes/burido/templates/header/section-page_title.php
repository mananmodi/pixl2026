...
if (!class_exists('Burido_Get_Page_Title')) {
    /**
     *  Page Title Area
     *
    ...
    class Burido_Get_Page_Title
    {
        ...
        public function get_title_text()
        {
            if (is_home() && is_front_page()) {
                ...
                if (!empty($post)) {
                    ...
                    $title = esc_html__('No Posts', 'burido');
        ...
        public function get_title_style()
        {
            ...
            $font_weight = ! empty( $pt_font[ 'font-weight' ] ) ? 'font-weight: ' . $pt_font[ 'font-weight' ] . ';' : '';
        ...
        public function get_breadcrumbs()
        {
            ...
            $font_weight = ! empty( $breadcrumbs_font[ 'font-weight' ] ) ? 'font-weight: ' . $breadcrumbs_font[ 'font-weight' ] . ';' : '';
