...
class WGL_Instagram extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Instagram', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'link_thumbnail',
            [
                'label' => esc_html__('Link Image', 'burido-core'),
                'type' => Controls_Manager::URL,
			    'dynamic' => ['active' => true],
                'label_block' => true,
            ]
        ...
        $repeater->add_control(
            'show_likes',
            [
                'label' => esc_html__('Show Likes?', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'author_name' => esc_html__('TINA OLSOS', 'burido-core'),
                        'info' => esc_html__('We have consistently focused on the intensity of development: the fundamental and basic part of the hands in blend with care items. Contact, rub, work... At home and in beauty institutes...', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .item__icon::before' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'icon_overlay',
            [
                'label' => esc_html__('Shape Background Color', 'burido-core'),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => ['icon_enabled' => 'yes'],
                'selectors' => [
        ...
        $this->add_control(
            'icon_overlay-dynamic',
            [
                'label' => esc_html__('Shape Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .item__icon::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '1024' => esc_html__('1024x1024', 'burido-core'),
                    '800' => esc_html__('800x800', 'burido-core'),
                    '680x740' => esc_html__('680x740', 'burido-core'),  // ratio = 1
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['info_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .item__info' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => ['info_bg!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .item__info' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'style_likes',
            [
                'label' => esc_html__('Likes', 'burido-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'icon_likes_enabled',
            [
                'label' => esc_html__('Icon Enabled', 'burido-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => ['likes_color!' => ''],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .likes_count' => 'color: {{VALUE}};',
                ],
            ]
        );
