...
{	
	...
	*/
	...
	public static function get_title() {
		return esc_html__( 'WGL Mobile Drawer', 'burido-core' );
	}
    ...
    public static function get_mobile_drawer_templates()
    {
        ...
        $options['wgl_default_template_drawer'] = esc_html__('Inherit From Theme Options', 'burido-core');
    ...
    public static function get_header_controls($document)
    {
        $document->start_controls_section(
            ...
            [
                'label' => esc_html__('WGL Header Drawer Template', 'burido-core'),
        ...
        $document->add_control(
            ...
            [
                'label' => esc_html__('Mobile Drawer Template', 'burido-core'),
	...
	public static function get_mobile_drawer_controls($document)
    {
        $document->start_controls_section(
            ...
            [
                'label' => esc_html__('WGL Mobile Drawer Options', 'burido-core'),
                'tab' => Controls_Manager::TAB_SETTINGS,
            ]
        );
        ...
        $document->add_control(
			...
			[
				'label' => esc_html__('Mobile Drawer Container', 'burido-core'),
        ...
        $document->add_control(
            ...
            [
				...
				'selectors_dictionary' => [
                    'left' => 'left: auto; transform: translateX(-100%);',
                    'right' => 'right: 0;transform: translateX(100%);',
                ],
                'selectors' => [
                    '{{WRAPPER}}  .wgl-menu_outer' => '{{VALUE}}',
                ],
            ]
        );
        ...
        $document->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Container Animation', 'burido-core' ),
				'type' => Controls_Manager::SELECT,
				'frontend_available' => true,
                'options' => [
					'translate' => esc_html__( 'Translate', 'burido-core' ),
					'fade_down' => esc_html__( 'Fade In Down', 'burido-core' ),
				],
                'default' => 'translate',
		...
		$document->add_control(
			...
			[
				'label' => esc_html__( 'Animation Delay', 'burido-core' ) . ' (ms)',
		...
		$document->add_control(
			...
			[
				'label' => esc_html__('Mobile Drawer Close Icon', 'burido-core'),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
        );
