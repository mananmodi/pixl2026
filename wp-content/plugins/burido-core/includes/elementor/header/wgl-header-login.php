...
class WGL_Header_login extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Login Button', 'burido-core' );
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'WooCommerce Login', 'burido-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'def' => esc_html__('Default', 'burido-core'),
        ...
        $this->add_control(
            'login_text',
            [
                'label' => esc_html__('Login Text', 'burido-core'),
                'type' => Controls_Manager::TEXT,
			    'dynamic' => ['active' => true],
                'default' => esc_html__('Login', 'burido-core'),
                'condition' => [
                    'button_text' => 'custom',
                ],
            ]
        ...
        $this->add_control(
            'logout_text',
            [
                'label' => esc_html__('Logout Text', 'burido-core'),
                'type' => Controls_Manager::TEXT,
			    'dynamic' => ['active' => true],
                'default' => esc_html__('Logout', 'burido-core'),
                'condition' => [
                    'button_text' => 'custom',
                ],
            ]
        ...
        */
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'color_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .login-in .login-in_wrapper a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'bg_idle-dynamic',
            [
                'label' => esc_html__('Background - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'bg_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .login-in .login-in_wrapper a' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .login-in .login-in_wrapper a' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'color_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .login-in .login-in_wrapper a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'condition' => [ 'bg_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .login-in .login-in_wrapper a:hover' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .login-in .login-in_wrapper a:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
    ...
    public function render()
    {
        ...
        $logout_text = esc_html__('Logout', 'burido-core');
        $login_text = esc_html__('Login', 'burido-core');
