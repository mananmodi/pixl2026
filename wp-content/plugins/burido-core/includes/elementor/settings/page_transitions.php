...
if (class_exists('Elementor\Core\Kits\Documents\Tabs\Tab_Base')) {
	class WGL_Page_Transitions_Controls extends Tab_Base {
		...
		public function get_title() {
			return esc_html__( 'WGL Page Transitions', 'burido-core' );
		}
		...
		protected function register_tab_controls() {
			$this->start_controls_section(
				...
				[
					...
					'label' => esc_html__( 'WGL Page Transitions', 'burido-core' ),
				]
			);
			...
			$this->add_control(
				...
				[
					'label' => esc_html__('Use Page Transition?', 'burido-core'),
				...
				[
					...
					'fields_options' => [
						'background' => [
							...
							'default' => 'classic',
							'description' => esc_html__( 'This is the page color behind your loading animation', 'burido-core' ),
						],
						'color' => [
							'default' => '#FFBC7D',
						],
			...
			$this->add_responsive_control(
				...
				[
					...
					'options' => [
						...
						'fade-out' => esc_html__( 'Fade In', 'burido-core' ),
						'fade-out-down' => esc_html__( 'Fade In Down', 'burido-core' ),
						'fade-out-right' => esc_html__( 'Fade In Right', 'burido-core' ),
						'fade-out-up' => esc_html__( 'Fade In Up', 'burido-core' ),
						'fade-out-left' => esc_html__( 'Fade In Left', 'burido-core' ),
						'zoom-out' => esc_html__( 'Zoom In', 'burido-core' ),
						'slide-out-down' => esc_html__( 'Slide In Down', 'burido-core' ),
						'slide-out-right' => esc_html__( 'Slide In Right', 'burido-core' ),
						'slide-out-up' => esc_html__( 'Slide In Up', 'burido-core' ),
						'slide-out-left' => esc_html__( 'Slide In Left', 'burido-core' ),
					],
					'condition' => [
						$this->get_control_id( 'use_page_transition' ) => 'yes',
					],
			...
			$this->add_responsive_control(
				...
				[
					'label' => esc_html__( 'Exit Animation', 'burido-core' ),
					'type' => Controls_Manager::SELECT,
					'label_block' => true,
					'options' => [
						'' => esc_html__( 'None', 'burido-core' ),
						'fade-in' => esc_html__( 'Fade Out', 'burido-core' ),
						'fade-in-down' => esc_html__( 'Fade Out Down', 'burido-core' ),
						'fade-in-right' => esc_html__( 'Fade Out Right', 'burido-core' ),
						'fade-in-up' => esc_html__( 'Fade Out Up', 'burido-core' ),
						'fade-in-left' => esc_html__( 'Fade Out Left', 'burido-core' ),
						'zoom-in' => esc_html__( 'Zoom Out', 'burido-core' ),
						'slide-in-down' => esc_html__( 'Slide Out Down', 'burido-core' ),
						'slide-in-right' => esc_html__( 'Slide Out Right', 'burido-core' ),
						'slide-in-up' => esc_html__( 'Slide Out Up', 'burido-core' ),
						'slide-in-left' => esc_html__( 'Slide Out Left', 'burido-core' ),
					],
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Animation Duration', 'burido-core' ) . ' (ms)',
