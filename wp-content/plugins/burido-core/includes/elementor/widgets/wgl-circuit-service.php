...
class WGL_Circuit_Service extends Widget_Base
{
    ...
    public function get_title() {
        return esc_html__('WGL Circuit Service', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'service_title',
            [
                'label' => esc_html__('Service Title', 'burido-core'),
        ...
        $this->add_control(
            'items',
            [
                'label' => esc_html__('Service', 'burido-core'),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'title_field' => '{{service_title}}',
                'default' => [
                    [
                        'service_title' => esc_html__('Circuit Title 1', 'burido-core'),
                        'service_icon_type' => 'font',
                        'service_icon_fontawesome' => [
                            'value' => 'fas fa-plus',
	                        'library' => 'fa-solid',
                    ...
                    [
                        'service_title' => esc_html__('Circuit Title 2', 'burido-core'),
                        'service_icon_type' => 'font',
                        'service_icon_fontawesome' => [
                            'value' => 'fas fa-car',
	                        'library' => 'fa-solid',
                    ...
                    [
                        'service_title' => esc_html__('Circuit Title 3', 'burido-core'),
                        'service_icon_type' => 'font',
                        'service_icon_fontawesome' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'icon_bg_color-dynamic',
            [
                'label' => esc_html__('Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'icon_bg_color!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_icon-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_item.active .wgl-services_icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-services_item.active .wgl-services_icon-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'icon_bg_h',
            [
                'label' => esc_html__('Icon Background Size', 'burido-core'),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [
