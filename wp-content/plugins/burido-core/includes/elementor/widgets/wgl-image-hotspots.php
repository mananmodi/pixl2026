...
class Wgl_Image_Hotspots extends Widget_Base
{
    ...
    {
        return esc_html__( 'WGL Image HotSpots', 'burido-core' );
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'content_hotspots',
            [ 'label' => esc_html__( 'HotSpots', 'burido-core' ) ]
        );
        ...
        $repeater->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'top' => esc_html__( 'Top', 'burido-core' ),
                    'right' => esc_html__( 'Right', 'burido-core' ),
                    'bottom' => esc_html__( 'Bottom', 'burido-core' ),
                ],
                'default' => 'left',
            ]
        );
        ...
        $repeater->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'ToolTip Position', 'burido-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__( 'Default', 'burido-core' ),
                    'top_l' => esc_html__( 'Top-Left', 'burido-core' ),
                    'top' => esc_html__( 'Top', 'burido-core' ),
                    'top_r' => esc_html__( 'Top-Right', 'burido-core' ),
                    'right' => esc_html__( 'Right', 'burido-core' ),
                    'bottom_r' => esc_html__( 'Bottom-Right', 'burido-core' ),
                    'bottom' => esc_html__( 'Bottom', 'burido-core' ),
                    'bottom_l' => esc_html__( 'Bottom-Left', 'burido-core' ),
                    'left' => esc_html__( 'Left', 'burido-core' ),
                ],
                'default' => '',
            ]
        ...
        $repeater->add_responsive_control(
            'tooltips_cur_margin',
            [
                'label' => esc_html__( 'ToolTip Margin', 'burido-core' ),
        ...
        $repeater->start_controls_tab(
            'hotspot_cur_styles',
            [ 'label' => esc_html__( 'Style', 'burido-core' ) ]
        );
        ...
        $repeater->add_control(
            'hotspot_cur_style',
            [
                'label' => esc_html__( 'Colors', 'burido-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__( 'Default', 'burido-core' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}} .hotspots_media-wrap' => 'color: {{VALUE}};fill: {{VALUE}};',
                ],
            ]
        );
        $repeater->add_control(
        ...
        $repeater->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}} .hotspots_point-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'text_c_background_idle-dynamic',
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}} .hotspots_point-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'icon_c_color_hover',
            [
                'label' => esc_html__( 'Hover Icon Color', 'burido-core' ),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => [ 'hotspot_cur_style' => 'custom' ],
                'selectors' => [
        ...
        $repeater->add_control(
            'icon_c_color_hover-dynamic',
            [
                'label' => esc_html__('Hover Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.hotspots__item:hover .hotspots_media-wrap' => 'color: {{VALUE}};fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            'text_c_color_hover',
            [
                'label' => esc_html__( 'Hover Text Color', 'burido-core' ),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => [ 'hotspot_cur_style' => 'custom' ],
                'selectors' => [
        ...
        $repeater->add_control(
            'text_c_color_hover-dynamic',
            [
                'label' => esc_html__('Hover Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.hotspots__item:hover .hotspots_point-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Hover Background Color', 'burido-core' ),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'condition' => [ 'hotspot_cur_style' => 'custom' ],
                'selectors' => [
        ...
        $repeater->add_control(
            'text_c_background_hover-dynamic',
            [
                'label' => esc_html__('Hover Background Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} {{CURRENT_ITEM}}.hotspots__item:hover .hotspots_point-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'repeater_data',
            [
                'label' => esc_html__( 'Hot Spots', 'burido-core' ),
        ...
        $this->start_controls_section(
            'content_tooltips',
            [ 'label' => esc_html__( 'ToolTips', 'burido-core' ) ]
        );

        $this->add_responsive_control(
            'show_always',
            [
                'label' => esc_html__( 'Show Always', 'burido-core' ),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'to_left' => esc_html__( 'To Left', 'burido-core' ),
                    'to_top' => esc_html__( 'To Top', 'burido-core' ),
                    'to_right' => esc_html__( 'To Right', 'burido-core' ),
                    'to_bottom' => esc_html__( 'To Bottom', 'burido-core' ),
                    'shake' => esc_html__( 'Shake', 'burido-core' ),
                ],
                'default' => 'fade',
            ]
        );
        ...
        $this->add_responsive_control(
            'show_triangle',
            [
                'label' => esc_html__( 'Show Triangle', 'burido-core' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control(
            'tooltip_width',
            [
                'label' => esc_html__( 'Container Width', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'range' => [
                    'px' => [ 'min' => 50, 'max' => 500 ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Append Icon?', 'burido-core' ),
                'type' => Controls_Manager::SWITCHER,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'interval',
            [
                'label' => esc_html__( 'HotSpots Appearing Interval (ms)', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
        ...
        $this->add_control(
            'loop_animation',
            [
                'label' => esc_html__( 'HotSpots Loop Animation', 'burido-core' ),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'loop_interval',
            [
                'label' => esc_html__( 'HotSpots Loop Interval (ms)', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
        ...
        $this->add_control(
            'loop_duration',
            [
                'label' => esc_html__( 'HotSpots Loop Duration (seconds)', 'burido-core' ),
                'type' => Controls_Manager::SLIDER,
			    'dynamic' => ['active' => true],
                'condition' => [ 'loop_animation!' => '' ],
                'range' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'condition' => [ 'loop_animation!' => '' ],
                'options' => [
                    'pulse' => esc_html__( 'Pulse', 'burido-core' ),
                    'shake' => esc_html__( 'Shake', 'burido-core' ),
                    'flash' => esc_html__( 'Flash', 'burido-core' ),
                    'zoom' => esc_html__( 'Zoom', 'burido-core' ),
                    'rubber' => esc_html__( 'Rubber', 'burido-core' ),
                    'swing' => esc_html__( 'Swing', 'burido-core' ),
                ],
                'default' => 'pulse',
            ]
        );
        ...
        $this->add_control(
            'text_tag',
            [
                'label' => esc_html__( 'Text Tag', 'burido-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => esc_html( '‹h1›' ),
                    'h2' => esc_html( '‹h2›' ),
        ...
        $this->add_control(
            'hotspots_border_color_idle-dynamic',
            [
                ...
                'dynamic' => ['active' => true],
                'condition' => [
                    'hotspots_border_border!' => ['', 'none'],
                    'hotspots_border_color_idle!' => ''
                ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots_point-wrap' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'icon_color_idle',
            [
                'label' => esc_html__( 'Dot | Icon Color', 'burido-core' ),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Dot | Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'icon_color_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots_point-icon.default' => 'background-color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots_media-wrap' => 'color: {{VALUE}};fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots_point-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hotspots_bg_idle',
            [
                'label' => esc_html__( 'Hot Spot Background', 'burido-core' ),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'selectors' => [
        ...
        $this->add_control(
            'hotspots_bg_idle-dynamic',
            [
                'label' => esc_html__('Hot Spot Background - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'hotspots_bg_idle!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots_point-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hotspots_border_color_hover-dynamic',
            [
                'label' => esc_html__('Border Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots__item:hover .hotspots_point-wrap' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots__item:hover .hotspots_point-icon.default' => 'background-color: {{VALUE}};',
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots__item:hover .hotspots_media-wrap' => 'color: {{VALUE}};fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots__item:hover .hotspots_point-text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hotspots_bg_hover-dynamic',
            [
                'label' => esc_html__('Hot Spot Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'hotspots_bg_hover!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .hotspots__item:hover .hotspots_point-wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
                ...
                'fields_options' => [
                    'box_shadow' => [
                        'default' => [
                            ...
                            'blur' => 0,
                            'spread' => 20,
                            'color' => WGL_Globals::get_primary_color( 0.15 ),
                        ],
                    ],
                ],
        ...
        $this->add_control(
            'tooltip_color-dynamic',
            [
                'label' => esc_html__('Text Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'tooltip_color!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .tooltip__wrapper' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'tooltip_icon_color',
            [
                'label' => esc_html__( 'Appended Icon Color', 'burido-core' ),
                'type' => Controls_Manager::COLOR,
			    'dynamic' => ['active' => true],
                'default' => WGL_Globals::get_primary_color(),
                'selectors' => [
        ...
        $this->add_control(
            'tooltip_icon_color-dynamic',
            [
                'label' => esc_html__('Appended Icon Color - Dynamic', 'burido-core'),
                'type' => Controls_Manager::COLOR,
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'tooltip_icon_color!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .tooltip__icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'separator' => 'after',
                'dynamic' => ['active' => true],
                'condition' => [ 'tooltip_bg!' => '' ],
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .tooltip__wrapper' => 'background-color: {{VALUE}};',
                ],
            ]
        );
