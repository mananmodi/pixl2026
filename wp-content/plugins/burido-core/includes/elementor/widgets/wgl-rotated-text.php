...
class WGL_Rotated_Text extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Rotated Text', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
			    ...
			    'dynamic' => ['active' => true],
                'rows' => 1,
                'default' => esc_html_x('Rotated Title', 'WGL Rotated Text', 'burido-core'),
            ]
        );
	    ...
	    $this->add_control(
		    ...
		    [
			    ...
			    'dynamic' => ['active' => true],
			    'label_block' => true,
                'placeholder' => esc_attr__('Rotated Sub-Title', 'burido-core'),
            ]
	    );
	    ...
	    $this->add_responsive_control(
		    'disable_rotation',
		    [
			    'label' => esc_html__('Disable Rotation', 'burido-core'),
	    ...
	    $this->add_control(
		    'link',
		    [
			    'label' => esc_html__('Module Link', 'burido-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .rt__title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .rt__title' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:hover .rt__title' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:hover .rt__title' => '-webkit-text-stroke-color: {{VALUE}};',
                ],
            ]
        );
	    $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .rt__subtitle' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:hover .rt__subtitle' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .media-wrapper' => 'background-color: {{VALUE}};',
                ],
            ]
        );
	    $this->end_controls_tab();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:hover .wgl-icon,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:focus .wgl-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    'body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:hover .media-wrapper,
                     body.wgl_dynamic_colors-active {{WRAPPER}} .wgl-rotated_text:focus .media-wrapper' => 'background-color: {{VALUE}};',
                ],
            ]
        );
