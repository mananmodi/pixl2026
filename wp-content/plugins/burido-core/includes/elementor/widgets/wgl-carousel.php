...
class WGL_Carousel extends Widget_Base
{
    ...
    {
        return esc_html__('WGL Carousel', 'burido-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'content_repeater',
            [
                'label' => esc_html__('Templates', 'burido-core'),
                'type' => Controls_Manager::REPEATER,
                'description' => esc_html__('Slider content is a template which you can choose from Elementor library. Each template will be a slider content', 'burido-core'),
                'fields' => $repeater->get_controls(),
                'title_field' => esc_html__('Template:', 'burido-core') . ' {{{ content }}}'
            ]
        );
        ...
        $this->start_controls_section(
            'navigation_section',
            ['label' => esc_html__('Pagination | Navigation', 'burido-core')]
        );
